...
func (nonrecordingInstrument) Add(context.Context, float64, ...attribute.KeyValue) {

}

func (nonrecordingInstrument) Record(context.Context, float64, ...attribute.KeyValue) {
