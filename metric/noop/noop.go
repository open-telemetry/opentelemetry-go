...
func (Observer) ObserveFloat64(instrument.Float64Observable, float64, ...instrument.Float64ObserveOption) {
}

// ObserveInt64 performs no operation.
func (Observer) ObserveInt64(instrument.Int64Observable, int64, ...instrument.Int64ObserveOption) {
}
...
func (Int64Counter) Add(context.Context, int64, ...instrument.Int64AddOption) {}
...
// Add performs no operation.
func (Float64Counter) Add(context.Context, float64, ...instrument.Float64AddOption) {}
...
// Add performs no operation.
func (Int64UpDownCounter) Add(context.Context, int64, ...instrument.Int64AddOption) {}
...
// Add performs no operation.
func (Float64UpDownCounter) Add(context.Context, float64, ...instrument.Float64AddOption) {}
...
func (Int64Histogram) Record(context.Context, int64, ...instrument.Int64RecordOption) {}
...
// Record performs no operation.
func (Float64Histogram) Record(context.Context, float64, ...instrument.Float64RecordOption) {}
...
func (Int64Observer) Observe(int64, ...instrument.Int64ObserveOption) {}
...
// Observe performs no operation.
func (Float64Observer) Observe(float64, ...instrument.Float64ObserveOption) {}
