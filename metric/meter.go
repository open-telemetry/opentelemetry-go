...
type Instrument = sdkapi.Instrument
type Callback = sdkapi.Callback

func (m Meter) NewCallback(insts []Instrument, function func(context.Context) error) (Callback, error) {
	return m.MeterImpl.NewCallback(insts, function)
}
