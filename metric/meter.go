...
type Meter interface {
	...
	Int64Counter(name string, options ...instrument.Int64Option) instrument.Int64Counter
	// Int64UpDownCounter returns a new instrument identified by name and
	// configured with options. The instrument is used to synchronously record
	// int64 measurements during a computational operation.
	Int64UpDownCounter(name string, options ...instrument.Int64Option) instrument.Int64UpDownCounter
	// Int64Histogram returns a new instrument identified by name and
	// configured with options. The instrument is used to synchronously record
	// the distribution of int64 measurements during a computational operation.
	Int64Histogram(name string, options ...instrument.Int64Option) instrument.Int64Histogram
	// Int64ObservableCounter returns a new instrument identified by name and
	// configured with options. The instrument is used to asynchronously record
	// increasing int64 measurements once per a measurement collection cycle.
	Int64ObservableCounter(name string, options ...instrument.Int64ObserverOption) instrument.Int64ObservableCounter
	...
	Int64ObservableUpDownCounter(name string, options ...instrument.Int64ObserverOption) instrument.Int64ObservableUpDownCounter
	// Int64ObservableGauge returns a new instrument identified by name and
	// configured with options. The instrument is used to asynchronously record
	// instantaneous int64 measurements once per a measurement collection
	// cycle.
	Int64ObservableGauge(name string, options ...instrument.Int64ObserverOption) instrument.Int64ObservableGauge
	...
	Float64Counter(name string, options ...instrument.Float64Option) instrument.Float64Counter
	// Float64UpDownCounter returns a new instrument identified by name and
	// configured with options. The instrument is used to synchronously record
	// float64 measurements during a computational operation.
	Float64UpDownCounter(name string, options ...instrument.Float64Option) instrument.Float64UpDownCounter
	...
	// operation.
	Float64Histogram(name string, options ...instrument.Float64Option) instrument.Float64Histogram
	// Float64ObservableCounter returns a new instrument identified by name and
	// configured with options. The instrument is used to asynchronously record
	// increasing float64 measurements once per a measurement collection cycle.
	Float64ObservableCounter(name string, options ...instrument.Float64ObserverOption) instrument.Float64ObservableCounter
	...
	// collection cycle.
	Float64ObservableUpDownCounter(name string, options ...instrument.Float64ObserverOption) instrument.Float64ObservableUpDownCounter
	// Float64ObservableGauge returns a new instrument identified by name and
	// configured with options. The instrument is used to asynchronously record
	// instantaneous float64 measurements once per a measurement collection
	// cycle.
	Float64ObservableGauge(name string, options ...instrument.Float64ObserverOption) instrument.Float64ObservableGauge
	...
	// during collection.
	RegisterCallback(f Callback, instruments ...instrument.Asynchronous) Registration
}
