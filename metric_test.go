...
func TestCounter(t *testing.T) {
	...
	t.Run("float64 counter", func(t *testing.T) {
		...
		checkSyncBatches(ctx, t, labels, mockSDK, otel.Float64NumberKind, otel.CounterKind, c.SyncImpl(),
			1994.1, -742, 42,
		)
	})
	t.Run("int64 counter", func(t *testing.T) {
		...
		checkSyncBatches(ctx, t, labels, mockSDK, otel.Int64NumberKind, otel.CounterKind, c.SyncImpl(),
			42, 4200, 420000,
		)
	...
	t.Run("int64 updowncounter", func(t *testing.T) {
		...
		meter.RecordBatch(ctx, labels, c.Measurement(42))
		checkSyncBatches(ctx, t, labels, mockSDK, otel.Int64NumberKind, otel.UpDownCounterKind, c.SyncImpl(),
			100, -100, 42,
		)
	})
	t.Run("float64 updowncounter", func(t *testing.T) {
		...
		checkSyncBatches(ctx, t, labels, mockSDK, otel.Float64NumberKind, otel.UpDownCounterKind, c.SyncImpl(),
			100.1, -76, -100.1,
		)
	})
}
...
func TestValueRecorder(t *testing.T) {
	t.Run("float64 valuerecorder", func(t *testing.T) {
		...
		checkSyncBatches(ctx, t, labels, mockSDK, otel.Float64NumberKind, otel.ValueRecorderKind, m.SyncImpl(),
			42, 0, -100.5,
		)
	})
	t.Run("int64 valuerecorder", func(t *testing.T) {
		...
		checkSyncBatches(ctx, t, labels, mockSDK, otel.Int64NumberKind, otel.ValueRecorderKind, m.SyncImpl(),
			173, 80, 0,
		)
	})
}
...
func TestObserverInstruments(t *testing.T) {
	t.Run("float valueobserver", func(t *testing.T) {
		...
		checkObserverBatch(t, labels, mockSDK, otel.Float64NumberKind, otel.ValueObserverKind, o.AsyncImpl(),
			42.1,
		)
	})
	t.Run("int valueobserver", func(t *testing.T) {
		...
		mockSDK.RunAsyncInstruments()
		checkObserverBatch(t, labels, mockSDK, otel.Int64NumberKind, otel.ValueObserverKind, o.AsyncImpl(),
			-142,
		)
	})
	t.Run("float sumobserver", func(t *testing.T) {
		...
		mockSDK.RunAsyncInstruments()
		checkObserverBatch(t, labels, mockSDK, otel.Float64NumberKind, otel.SumObserverKind, o.AsyncImpl(),
			42.1,
		)
	})
	t.Run("int sumobserver", func(t *testing.T) {
		...
		mockSDK.RunAsyncInstruments()
		checkObserverBatch(t, labels, mockSDK, otel.Int64NumberKind, otel.SumObserverKind, o.AsyncImpl(),
			-142,
		)
	})
	t.Run("float updownsumobserver", func(t *testing.T) {
		...
		mockSDK.RunAsyncInstruments()
		checkObserverBatch(t, labels, mockSDK, otel.Float64NumberKind, otel.UpDownSumObserverKind, o.AsyncImpl(),
			42.1,
		)
	})
	t.Run("int updownsumobserver", func(t *testing.T) {
		...
		mockSDK.RunAsyncInstruments()
		checkObserverBatch(t, labels, mockSDK, otel.Int64NumberKind, otel.UpDownSumObserverKind, o.AsyncImpl(),
			-142,
		)
	})
}
...
func TestBatchObserverInstruments(t *testing.T) {
	...
	require.Equal(t, 0, m1.Number.CompareNumber(otel.Int64NumberKind, metrictest.ResolveNumberByKind(t, otel.Int64NumberKind, 42)))
