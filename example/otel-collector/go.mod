...
require (
	go.opentelemetry.io/otel v1.0.2
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.0.2
	go.opentelemetry.io/otel/sdk v1.0.2
	go.opentelemetry.io/otel/trace v1.0.2
