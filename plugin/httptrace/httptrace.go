...
func Extract(req *http.Request) ([]core.KeyValue, []core.KeyValue, core.SpanContext) {
	...
	sc.IDHigh = encoding.Uint64(tc.TraceParent.TraceID[0:8])
	sc.IDLow = encoding.Uint64(tc.TraceParent.TraceID[8:16])
...
func (h hinjector) Inject(sc core.SpanContext, tags tag.Map) {
	...
	encoding.PutUint64(tid[0:8], sc.IDHigh)
	encoding.PutUint64(tid[8:16], sc.IDLow)
