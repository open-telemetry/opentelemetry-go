...
type enabledFn func(context.Context, log.EnabledOpts) bool

var defaultEnabledFunc = func(context.Context, log.EnabledOpts) bool {
	return true
}
...
func WithEnabledFunc(fn func(context.Context, log.EnabledOpts) bool) Option {
