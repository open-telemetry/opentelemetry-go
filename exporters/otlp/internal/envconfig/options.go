...
// NewHTTPTracesConfig returns a new Config with all settings applied from opts and
// any unset setting using the default HTTP config values.
func NewHTTPTracesConfig(opts ...HTTPOption) Config {
	cfg := Config{
		Sc: SignalConfig{
...
// NewGRPCTracesConfig returns a new Config with all settings applied from opts and
// any unset setting using the default gRPC config values.
func NewGRPCTracesConfig(opts ...GRPCOption) Config {
	cfg := Config{
		Sc: SignalConfig{
