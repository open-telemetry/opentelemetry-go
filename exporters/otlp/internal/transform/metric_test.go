...
func TestMinMaxSumCountMetricDescriptor(t *testing.T) {
	...
	for _, test := range tests {
		...
		labels := export.NewSimpleLabels(export.LabelSlice(test.labels), export.NoopLabelExporter{})
...
func TestMinMaxSumCountDatapoints(t *testing.T) {
	...
	labels := export.NewSimpleLabels(export.LabelSlice(nil), export.NoopLabelExporter{})
