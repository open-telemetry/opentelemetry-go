...
func TestLinks(t *testing.T) {
	...
	l := []otel.Link{
		{},
		{
			SpanContext: otel.EmptySpanContext(),
			Attributes:  attrs,
		},
	}
	got := links(l)
...
func TestSpanData(t *testing.T) {
	...
	spanData := &export.SpanData{
		SpanContext: otel.SpanContext{
			TraceID: otel.ID{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F},
		...
		Links: []otel.Link{
			{
				SpanContext: otel.SpanContext{
					TraceID:    otel.ID{0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCF},
			...
			{
				SpanContext: otel.SpanContext{
					TraceID:    otel.ID{0xE0, 0xE1, 0xE2, 0xE3, 0xE4, 0xE5, 0xE6, 0xE7, 0xE8, 0xE9, 0xEA, 0xEB, 0xEC, 0xED, 0xEE, 0xEF},
