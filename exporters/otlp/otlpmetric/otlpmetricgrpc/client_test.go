...
func TestEmptyData(t *testing.T) {
	...
	assert.NoError(t, exp.Export(ctx, testResource, otlpmetrictest.EmptyMetricReader()))
}
...
func TestFailedMetricTransform(t *testing.T) {
	...
	assert.Error(t, exp.Export(ctx, testResource, otlpmetrictest.FailMetricReader{}))
}
