...
func WithHeadersProvider(headersProviderFunc HeadersProviderFunc) Option {
	return wrappedOption{otlpconfig.WithHeaderProvider(otlpconfig.HeadersProviderFunc(headersProviderFunc))}
}
