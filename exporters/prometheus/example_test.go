...
func Example() {
	...
	// bar_total{otel_scope_name="example-global",otel_scope_schema_url="https://opentelemetry.io/schemas/1.43.0",otel_scope_version="v1.0.0"} 10
}
...
func Example_customRegistry() {
	...
	// foo_total{otel_scope_name="example-custom",otel_scope_schema_url="https://opentelemetry.io/schemas/1.43.0",otel_scope_version="v1.0.0"} 5
}
...
func Example_noTranslation() {
	...
	// {"my.metric",otel_scope_name="example-no-translation",otel_scope_schema_url="https://opentelemetry.io/schemas/1.43.0",otel_scope_version="v1.0.0"} 5
}
