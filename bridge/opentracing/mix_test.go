...
func (bio *baggageInteroperationTest) addAndRecordBaggage(t *testing.T, ctx context.Context) context.Context {
	...
	ctx = baggage.NewContext(ctx, label.String(otelKey, value))
...
func checkTraceAndSpans(t *testing.T, tracer *internal.MockTracer, expectedTraceID otel.ID, expectedSpanIDs []otel.SpanID) {
