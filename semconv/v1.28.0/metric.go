...
const (
  ...
  // K8SNodeMemoryUsage is the metric conforming to the "k8s.node.memory.usage" semantic conventions. It represents the memory usage of the Node.
  // Instrument: gauge
  // Unit: By
  // Stability: experimental
  ...
  // K8SPodMemoryUsage is the metric conforming to the "k8s.pod.memory.usage" semantic conventions. It represents the memory usage of the Pod.
  // Instrument: gauge
  // Unit: By
  // Stability: experimental
  ...
  // MessagingClientPublishedMessages is the metric conforming to the "messaging.client.published.messages" semantic conventions. It represents the deprecated. Use `messaging.client.sent.messages` instead.
  // Instrument: counter
  // Unit: {message}
  // Stability: experimental
  ...
  // MessagingClientSentMessages is the metric conforming to the "messaging.client.sent.messages" semantic conventions. It represents the number of messages producer attempted to send to the broker.
  // Instrument: counter
  // Unit: {message}
  // Stability: experimental
  ...
  // SystemFilesystemLimit is the metric conforming to the "system.filesystem.limit" semantic conventions. It represents the total storage capacity of the filesystem.
  // Instrument: updowncounter
  // Unit: By
  // Stability: experimental
  ...
  // SystemFilesystemUsage is the metric conforming to the "system.filesystem.usage" semantic conventions. It represents the reports a filesystem's space usage across different states.
  // Instrument: updowncounter
  // Unit: By
  // Stability: experimental
