...
// Namespace: android
const (
	// AndroidOSAPILevelKey is the attribute Key conforming to the "android.os.api_level" semantic conventions. It represents the uniquely identifies the framework API revision offered by a version (`os.version`) of the android operating system. More information can be found [here].
	// 
	// Type: string
...
// Namespace: artifact
const (
	// ArtifactAttestationFilenameKey is the attribute Key conforming to the "artifact.attestation.filename" semantic conventions. It represents the provenance filename of the built attestation which directly relates to the build artifact filename. This filename SHOULD accompany the artifact at publish time. See the [SLSA Relationship] specification for more information.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "golang-binary-amd64-v0.1.0.attestation", "docker-image-amd64-v0.1.0.intoto.json1", "release-1.tar.gz.attestation", "file-name-package.tar.gz.intoto.json1"
	// 
	...
	// ArtifactAttestationHashKey is the attribute Key conforming to the "artifact.attestation.hash" semantic conventions. It represents the full [hash value (see glossary)], of the built attestation. Some envelopes in the software attestation space also refer to this as the [digest].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ArtifactAttestationIDKey is the attribute Key conforming to the "artifact.attestation.id" semantic conventions. It represents the id of the build [software attestation].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ArtifactFilenameKey is the attribute Key conforming to the "artifact.filename" semantic conventions. It represents the human readable file name of the artifact, typically generated during build and release processes. Often includes the package name and version in the file name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "golang-binary-amd64-v0.1.0", "docker-image-amd64-v0.1.0", "release-1.tar.gz", "file-name-package.tar.gz"
	...
	// ArtifactHashKey is the attribute Key conforming to the "artifact.hash" semantic conventions. It represents the full [hash value (see glossary)], often found in checksum.txt on a release of the artifact and used to verify package integrity.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ArtifactPurlKey is the attribute Key conforming to the "artifact.purl" semantic conventions. It represents the [Package URL] of the [package artifact] provides a standard way to identify and locate the packaged artifact.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ArtifactVersionKey is the attribute Key conforming to the "artifact.version" semantic conventions. It represents the version of the artifact.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
const (
	// ASPNETCoreDiagnosticsExceptionResultKey is the attribute Key conforming to the "aspnetcore.diagnostics.exception.result" semantic conventions. It represents the aSP.NET Core exception middleware handling result.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ASPNETCoreDiagnosticsHandlerTypeKey is the attribute Key conforming to the "aspnetcore.diagnostics.handler.type" semantic conventions. It represents the full type name of the [`IExceptionHandler`] implementation that handled the exception.
	// 
	// Type: string
	// RequirementLevel: {"Conditionally_Required": "If And Only If The Exception Was Handled By This Handler."}
	// Stability: Stable
	// 
	...
	// ASPNETCoreRateLimitingPolicyKey is the attribute Key conforming to the "aspnetcore.rate_limiting.policy" semantic conventions. It represents the rate limiting policy name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ASPNETCoreRateLimitingResultKey is the attribute Key conforming to the "aspnetcore.rate_limiting.result" semantic conventions. It represents the rate-limiting result, shows whether the lease was acquired or contains a rejection reason.
	// 
	// Type: Enum
	...
	// ASPNETCoreRequestIsUnhandledKey is the attribute Key conforming to the "aspnetcore.request.is_unhandled" semantic conventions. It represents the flag indicating if request was handled by the application pipeline.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ASPNETCoreRoutingIsFallbackKey is the attribute Key conforming to the "aspnetcore.routing.is_fallback" semantic conventions. It represents a value that indicates whether the matched route is a fallback route.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ASPNETCoreRoutingMatchStatusKey is the attribute Key conforming to the "aspnetcore.routing.match_status" semantic conventions. It represents the match result - success or failure.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
...
// ASPNETCoreDiagnosticsHandlerType returns an attribute KeyValue conforming to the "aspnetcore.diagnostics.handler.type" semantic conventions. It represents the full type name of the [`IExceptionHandler`] implementation that handled the exception.
// 
// [`IExceptionHandler`]: https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.diagnostics.iexceptionhandler
...
// Namespace: aws
const (
	// AWSDynamoDBAttributeDefinitionsKey is the attribute Key conforming to the "aws.dynamodb.attribute_definitions" semantic conventions. It represents the JSON-serialized value of each item in the `AttributeDefinitions` request field.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBAttributesToGetKey is the attribute Key conforming to the "aws.dynamodb.attributes_to_get" semantic conventions. It represents the value of the `AttributesToGet` request parameter.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBConsistentReadKey is the attribute Key conforming to the "aws.dynamodb.consistent_read" semantic conventions. It represents the value of the `ConsistentRead` request parameter.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBConsumedCapacityKey is the attribute Key conforming to the "aws.dynamodb.consumed_capacity" semantic conventions. It represents the JSON-serialized value of each item in the `ConsumedCapacity` response field.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBCountKey is the attribute Key conforming to the "aws.dynamodb.count" semantic conventions. It represents the value of the `Count` response parameter.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBExclusiveStartTableKey is the attribute Key conforming to the "aws.dynamodb.exclusive_start_table" semantic conventions. It represents the value of the `ExclusiveStartTableName` request parameter.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBGlobalSecondaryIndexUpdatesKey is the attribute Key conforming to the "aws.dynamodb.global_secondary_index_updates" semantic conventions. It represents the JSON-serialized value of each item in the `GlobalSecondaryIndexUpdates` request field.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "{ "Create": { "IndexName": "string", "KeySchema": [ { "AttributeName": "string", "KeyType": "string" } ], "Projection": { "NonKeyAttributes": [ "string" ], "ProjectionType": "string" }, "ProvisionedThroughput": { "ReadCapacityUnits": number, "WriteCapacityUnits": number } }"
	AWSDynamoDBGlobalSecondaryIndexUpdatesKey = attribute.Key("aws.dynamodb.global_secondary_index_updates")

	// AWSDynamoDBGlobalSecondaryIndexesKey is the attribute Key conforming to the "aws.dynamodb.global_secondary_indexes" semantic conventions. It represents the JSON-serialized value of each item of the `GlobalSecondaryIndexes` request field.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "{ "IndexName": "string", "KeySchema": [ { "AttributeName": "string", "KeyType": "string" } ], "Projection": { "NonKeyAttributes": [ "string" ], "ProjectionType": "string" }, "ProvisionedThroughput": { "ReadCapacityUnits": number, "WriteCapacityUnits": number } }"
	AWSDynamoDBGlobalSecondaryIndexesKey = attribute.Key("aws.dynamodb.global_secondary_indexes")

	// AWSDynamoDBIndexNameKey is the attribute Key conforming to the "aws.dynamodb.index_name" semantic conventions. It represents the value of the `IndexName` request parameter.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBItemCollectionMetricsKey is the attribute Key conforming to the "aws.dynamodb.item_collection_metrics" semantic conventions. It represents the JSON-serialized value of the `ItemCollectionMetrics` response field.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "{ "string" : [ { "ItemCollectionKey": { "string" : { "B": blob, "BOOL": boolean, "BS": [ blob ], "L": [ "AttributeValue" ], "M": { "string" : "AttributeValue" }, "N": "string", "NS": [ "string" ], "NULL": boolean, "S": "string", "SS": [ "string" ] } }, "SizeEstimateRangeGB": [ number ] } ] }"
	AWSDynamoDBItemCollectionMetricsKey = attribute.Key("aws.dynamodb.item_collection_metrics")

	// AWSDynamoDBLimitKey is the attribute Key conforming to the "aws.dynamodb.limit" semantic conventions. It represents the value of the `Limit` request parameter.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBLocalSecondaryIndexesKey is the attribute Key conforming to the "aws.dynamodb.local_secondary_indexes" semantic conventions. It represents the JSON-serialized value of each item of the `LocalSecondaryIndexes` request field.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBProjectionKey is the attribute Key conforming to the "aws.dynamodb.projection" semantic conventions. It represents the value of the `ProjectionExpression` request parameter.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBProvisionedReadCapacityKey is the attribute Key conforming to the "aws.dynamodb.provisioned_read_capacity" semantic conventions. It represents the value of the `ProvisionedThroughput.ReadCapacityUnits` request parameter.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBProvisionedWriteCapacityKey is the attribute Key conforming to the "aws.dynamodb.provisioned_write_capacity" semantic conventions. It represents the value of the `ProvisionedThroughput.WriteCapacityUnits` request parameter.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBScanForwardKey is the attribute Key conforming to the "aws.dynamodb.scan_forward" semantic conventions. It represents the value of the `ScanIndexForward` request parameter.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBScannedCountKey is the attribute Key conforming to the "aws.dynamodb.scanned_count" semantic conventions. It represents the value of the `ScannedCount` response parameter.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBSegmentKey is the attribute Key conforming to the "aws.dynamodb.segment" semantic conventions. It represents the value of the `Segment` request parameter.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBSelectKey is the attribute Key conforming to the "aws.dynamodb.select" semantic conventions. It represents the value of the `Select` request parameter.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBTableCountKey is the attribute Key conforming to the "aws.dynamodb.table_count" semantic conventions. It represents the number of items in the `TableNames` response parameter.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBTableNamesKey is the attribute Key conforming to the "aws.dynamodb.table_names" semantic conventions. It represents the keys in the `RequestItems` object field.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSDynamoDBTotalSegmentsKey is the attribute Key conforming to the "aws.dynamodb.total_segments" semantic conventions. It represents the value of the `TotalSegments` request parameter.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSECSClusterARNKey is the attribute Key conforming to the "aws.ecs.cluster.arn" semantic conventions. It represents the ARN of an [ECS cluster].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSECSContainerARNKey is the attribute Key conforming to the "aws.ecs.container.arn" semantic conventions. It represents the Amazon Resource Name (ARN) of an [ECS container instance].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSECSLaunchtypeKey is the attribute Key conforming to the "aws.ecs.launchtype" semantic conventions. It represents the [launch type] for an ECS task.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSECSTaskARNKey is the attribute Key conforming to the "aws.ecs.task.arn" semantic conventions. It represents the ARN of a running [ECS task].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "arn:aws:ecs:us-west-1:123456789123:task/10838bed-421f-43ef-870a-f43feacbbb5b", "arn:aws:ecs:us-west-1:123456789123:task/my-cluster/task-id/23ebb8ac-c18f-46c6-8bbe-d55d0e37cfbd"
	// 
	// [ECS task]: https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-account-settings.html#ecs-resource-ids
	AWSECSTaskARNKey = attribute.Key("aws.ecs.task.arn")

	// AWSECSTaskFamilyKey is the attribute Key conforming to the "aws.ecs.task.family" semantic conventions. It represents the family name of the [ECS task definition] used to create the ECS task.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSECSTaskIDKey is the attribute Key conforming to the "aws.ecs.task.id" semantic conventions. It represents the ID of a running ECS task. The ID MUST be extracted from `task.arn`.
	// 
	// Type: string
	// RequirementLevel: {"Conditionally_Required": "If And Only If `Task.Arn` Is Populated."}
	// Stability: Experimental
	// 
	// Examples: "10838bed-421f-43ef-870a-f43feacbbb5b", "23ebb8ac-c18f-46c6-8bbe-d55d0e37cfbd"
	AWSECSTaskIDKey = attribute.Key("aws.ecs.task.id")

	// AWSECSTaskRevisionKey is the attribute Key conforming to the "aws.ecs.task.revision" semantic conventions. It represents the revision for the task definition used to create the ECS task.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSEKSClusterARNKey is the attribute Key conforming to the "aws.eks.cluster.arn" semantic conventions. It represents the ARN of an EKS cluster.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSLambdaInvokedARNKey is the attribute Key conforming to the "aws.lambda.invoked_arn" semantic conventions. It represents the full invoked ARN as provided on the `Context` passed to the function (`Lambda-Runtime-Invoked-Function-Arn` header on the `/runtime/invocation/next` applicable).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSLogGroupARNsKey is the attribute Key conforming to the "aws.log.group.arns" semantic conventions. It represents the Amazon Resource Name(s) (ARN) of the AWS log group(s).
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSLogGroupNamesKey is the attribute Key conforming to the "aws.log.group.names" semantic conventions. It represents the name(s) of the AWS log group(s) an application is writing to.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSLogStreamARNsKey is the attribute Key conforming to the "aws.log.stream.arns" semantic conventions. It represents the ARN(s) of the AWS log stream(s).
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSLogStreamNamesKey is the attribute Key conforming to the "aws.log.stream.names" semantic conventions. It represents the name(s) of the AWS log stream(s) an application is writing to.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSRequestIDKey is the attribute Key conforming to the "aws.request_id" semantic conventions. It represents the AWS request ID as returned in the response headers `x-amz-request-id` or `x-amz-requestid`.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSS3BucketKey is the attribute Key conforming to the "aws.s3.bucket" semantic conventions. It represents the S3 bucket name the request refers to. Corresponds to the `--bucket` parameter of the [S3 API] operations.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSS3CopySourceKey is the attribute Key conforming to the "aws.s3.copy_source" semantic conventions. It represents the source object (in the form `bucket`/`key`) for the copy operation.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSS3DeleteKey is the attribute Key conforming to the "aws.s3.delete" semantic conventions. It represents the delete request container that specifies the objects to be deleted.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSS3KeyKey is the attribute Key conforming to the "aws.s3.key" semantic conventions. It represents the S3 object key the request refers to. Corresponds to the `--key` parameter of the [S3 API] operations.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSS3PartNumberKey is the attribute Key conforming to the "aws.s3.part_number" semantic conventions. It represents the part number of the part being uploaded in a multipart-upload operation. This is a positive integer between 1 and 10,000.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AWSS3UploadIDKey is the attribute Key conforming to the "aws.s3.upload_id" semantic conventions. It represents the upload ID that identifies the multipart upload.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: az
const (
	// AzNamespaceKey is the attribute Key conforming to the "az.namespace" semantic conventions. It represents the [Azure Resource Provider Namespace] as recognized by the client.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// AzServiceRequestIDKey is the attribute Key conforming to the "az.service_request_id" semantic conventions. It represents the unique identifier of the service request. It's generated by the Azure service and returned with the response.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: browser
const (
	// BrowserBrandsKey is the attribute Key conforming to the "browser.brands" semantic conventions. It represents the array of brand name and version separated by a space.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// BrowserLanguageKey is the attribute Key conforming to the "browser.language" semantic conventions. It represents the preferred language of the user using the browser.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// BrowserMobileKey is the attribute Key conforming to the "browser.mobile" semantic conventions. It represents a boolean that is true if the browser is running on a mobile device.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// BrowserPlatformKey is the attribute Key conforming to the "browser.platform" semantic conventions. It represents the platform on which the browser is running.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: cicd
const (
	// CICDPipelineNameKey is the attribute Key conforming to the "cicd.pipeline.name" semantic conventions. It represents the human readable name of the pipeline within a CI/CD system.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "Build and Test", "Lint", "Deploy Go Project", "deploy_to_environment"
	CICDPipelineNameKey = attribute.Key("cicd.pipeline.name")

	// CICDPipelineRunIDKey is the attribute Key conforming to the "cicd.pipeline.run.id" semantic conventions. It represents the unique identifier of a pipeline run within a CI/CD system.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CICDPipelineTaskRunIDKey is the attribute Key conforming to the "cicd.pipeline.task.run.id" semantic conventions. It represents the unique identifier of a task run within a pipeline.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CICDPipelineTaskRunURLFullKey is the attribute Key conforming to the "cicd.pipeline.task.run.url.full" semantic conventions. It represents the [URL] of the pipeline run providing the complete address in order to locate and identify the pipeline run.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CICDPipelineTaskTypeKey is the attribute Key conforming to the "cicd.pipeline.task.type" semantic conventions. It represents the type of the task within a pipeline.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: client
const (
	// ClientAddressKey is the attribute Key conforming to the "client.address" semantic conventions. It represents the client address - domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ClientPortKey is the attribute Key conforming to the "client.port" semantic conventions. It represents the client port number.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: cloud
const (
	// CloudAccountIDKey is the attribute Key conforming to the "cloud.account.id" semantic conventions. It represents the cloud account ID the resource is assigned to.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudAvailabilityZoneKey is the attribute Key conforming to the "cloud.availability_zone" semantic conventions. It represents the cloud regions often have multiple, isolated locations known as zones to increase availability. Availability zone represents the zone where the resource is running.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudRegionKey is the attribute Key conforming to the "cloud.region" semantic conventions. It represents the geographical region the resource is running.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudResourceIDKey is the attribute Key conforming to the "cloud.resource_id" semantic conventions. It represents the cloud provider-specific native identifier of the monitored cloud resource (e.g. an [ARN] on AWS, a [fully qualified resource ID] on Azure, a [full resource name] on GCP).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "arn:aws:lambda:REGION:ACCOUNT_ID:function:my-function", "//run.googleapis.com/projects/PROJECT_ID/locations/LOCATION_ID/services/SERVICE_ID", "/subscriptions/<SUBSCRIPTION_GUID>/resourceGroups/<RG>/providers/Microsoft.Web/sites/<FUNCAPP>/functions/<FUNC>"
...
const (
	// CloudeventsEventIDKey is the attribute Key conforming to the "cloudevents.event_id" semantic conventions. It represents the [event_id] uniquely identifies the event.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudeventsEventSourceKey is the attribute Key conforming to the "cloudevents.event_source" semantic conventions. It represents the [source] identifies the context in which an event happened.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudeventsEventSpecVersionKey is the attribute Key conforming to the "cloudevents.event_spec_version" semantic conventions. It represents the [version of the CloudEvents specification] which the event uses.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudeventsEventSubjectKey is the attribute Key conforming to the "cloudevents.event_subject" semantic conventions. It represents the [subject] of the event in the context of the event producer (identified by source).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudeventsEventTypeKey is the attribute Key conforming to the "cloudevents.event_type" semantic conventions. It represents the [event_type] contains a value describing the type of event related to the originating occurrence.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
const (
	// CloudfoundryAppIDKey is the attribute Key conforming to the "cloudfoundry.app.id" semantic conventions. It represents the guid of the application.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundryAppInstanceIDKey is the attribute Key conforming to the "cloudfoundry.app.instance.id" semantic conventions. It represents the index of the application instance. 0 when just one instance is active.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundryAppNameKey is the attribute Key conforming to the "cloudfoundry.app.name" semantic conventions. It represents the name of the application.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundryOrgIDKey is the attribute Key conforming to the "cloudfoundry.org.id" semantic conventions. It represents the guid of the CloudFoundry org the application is running in.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundryOrgNameKey is the attribute Key conforming to the "cloudfoundry.org.name" semantic conventions. It represents the name of the CloudFoundry organization the app is running in.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundryProcessIDKey is the attribute Key conforming to the "cloudfoundry.process.id" semantic conventions. It represents the UID identifying the process.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundryProcessTypeKey is the attribute Key conforming to the "cloudfoundry.process.type" semantic conventions. It represents the type of process.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundrySpaceIDKey is the attribute Key conforming to the "cloudfoundry.space.id" semantic conventions. It represents the guid of the CloudFoundry space the application is running in.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundrySpaceNameKey is the attribute Key conforming to the "cloudfoundry.space.name" semantic conventions. It represents the name of the CloudFoundry space the application is running in.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundrySystemIDKey is the attribute Key conforming to the "cloudfoundry.system.id" semantic conventions. It represents a guid or another name describing the event source.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CloudfoundrySystemInstanceIDKey is the attribute Key conforming to the "cloudfoundry.system.instance.id" semantic conventions. It represents a guid describing the concrete instance of the event source.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: code
const (
	// CodeColumnKey is the attribute Key conforming to the "code.column" semantic conventions. It represents the column number in `code.filepath` best representing the operation. It SHOULD point within the code unit named in `code.function`.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CodeFilepathKey is the attribute Key conforming to the "code.filepath" semantic conventions. It represents the source code file name that identifies the code unit as uniquely as possible (preferably an absolute file path).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CodeFunctionKey is the attribute Key conforming to the "code.function" semantic conventions. It represents the method or function name, or equivalent (usually rightmost part of the code unit's name).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CodeLineNumberKey is the attribute Key conforming to the "code.lineno" semantic conventions. It represents the line number in `code.filepath` best representing the operation. It SHOULD point within the code unit named in `code.function`.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CodeNamespaceKey is the attribute Key conforming to the "code.namespace" semantic conventions. It represents the "namespace" within which `code.function` is defined. Usually the qualified class or module name, such that `code.namespace` + some separator + `code.function` form a unique identifier for the code unit.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// CodeStacktraceKey is the attribute Key conforming to the "code.stacktrace" semantic conventions. It represents a stacktrace as a string in the natural representation for the language runtime. The representation is to be determined and documented by each language SIG.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: container
const (
	// ContainerCommandKey is the attribute Key conforming to the "container.command" semantic conventions. It represents the command used to run the container (i.e. the command name).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerCommandArgsKey is the attribute Key conforming to the "container.command_args" semantic conventions. It represents the all the command arguments (including the command/executable itself) run by the container.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerCommandLineKey is the attribute Key conforming to the "container.command_line" semantic conventions. It represents the full command run by the container as a single string representing the full command.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerCsiPluginNameKey is the attribute Key conforming to the "container.csi.plugin.name" semantic conventions. It represents the name of the CSI ([Container Storage Interface]) plugin used by the volume.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerCsiVolumeIDKey is the attribute Key conforming to the "container.csi.volume.id" semantic conventions. It represents the unique volume ID returned by the CSI ([Container Storage Interface]) plugin.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerIDKey is the attribute Key conforming to the "container.id" semantic conventions. It represents the container ID. Usually a UUID, as for example used to [identify Docker containers]. The UUID might be abbreviated.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerImageIDKey is the attribute Key conforming to the "container.image.id" semantic conventions. It represents the runtime specific image identifier. Usually a hash algorithm followed by a UUID.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerImageNameKey is the attribute Key conforming to the "container.image.name" semantic conventions. It represents the name of the image the container was built on.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerImageRepoDigestsKey is the attribute Key conforming to the "container.image.repo_digests" semantic conventions. It represents the repo digests of the container image as provided by the container runtime.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerImageTagsKey is the attribute Key conforming to the "container.image.tags" semantic conventions. It represents the container image tags. An example can be found in [Docker Image Inspect]. Should be only the `<tag>` section of the full name for example from `registry.example.com/my-org/my-image:<tag>`.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerNameKey is the attribute Key conforming to the "container.name" semantic conventions. It represents the container name used by container runtime.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ContainerRuntimeKey is the attribute Key conforming to the "container.runtime" semantic conventions. It represents the container runtime managing this container.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: cpu
const (
	// CPUModeKey is the attribute Key conforming to the "cpu.mode" semantic conventions. It represents the mode of the CPU.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: db
const (
	// DBCassandraConsistencyLevelKey is the attribute Key conforming to the "db.cassandra.consistency_level" semantic conventions. It represents the consistency level of the query. Based on consistency values from [CQL].
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCassandraCoordinatorDCKey is the attribute Key conforming to the "db.cassandra.coordinator.dc" semantic conventions. It represents the data center of the coordinating node for a query.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCassandraCoordinatorIDKey is the attribute Key conforming to the "db.cassandra.coordinator.id" semantic conventions. It represents the ID of the coordinating node for a query.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCassandraIdempotenceKey is the attribute Key conforming to the "db.cassandra.idempotence" semantic conventions. It represents the whether or not the query is idempotent.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCassandraPageSizeKey is the attribute Key conforming to the "db.cassandra.page_size" semantic conventions. It represents the fetch size used for paging, i.e. how many rows will be returned at once.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCassandraSpeculativeExecutionCountKey is the attribute Key conforming to the "db.cassandra.speculative_execution_count" semantic conventions. It represents the number of times a query was speculatively executed. Not set or `0` if the query was not executed speculatively.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBClientConnectionStateKey is the attribute Key conforming to the "db.client.connection.state" semantic conventions. It represents the state of a connection in the pool.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCollectionNameKey is the attribute Key conforming to the "db.collection.name" semantic conventions. It represents the name of a collection (table, container) within the database.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCosmosDBClientIDKey is the attribute Key conforming to the "db.cosmosdb.client_id" semantic conventions. It represents the unique Cosmos client instance id.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCosmosDBConnectionModeKey is the attribute Key conforming to the "db.cosmosdb.connection_mode" semantic conventions. It represents the cosmos client connection mode.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCosmosDBOperationTypeKey is the attribute Key conforming to the "db.cosmosdb.operation_type" semantic conventions. It represents the cosmos DB Operation Type.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCosmosDBRequestChargeKey is the attribute Key conforming to the "db.cosmosdb.request_charge" semantic conventions. It represents the rU consumed for that operation.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCosmosDBRequestContentLengthKey is the attribute Key conforming to the "db.cosmosdb.request_content_length" semantic conventions. It represents the request payload size in bytes.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBCosmosDBSubStatusCodeKey is the attribute Key conforming to the "db.cosmosdb.sub_status_code" semantic conventions. It represents the cosmos DB sub status code.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBElasticsearchNodeNameKey is the attribute Key conforming to the "db.elasticsearch.node.name" semantic conventions. It represents the represents the human-readable identifier of the node/instance to which a request was routed.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBNamespaceKey is the attribute Key conforming to the "db.namespace" semantic conventions. It represents the name of the database, fully qualified within the server address and port.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBOperationBatchSizeKey is the attribute Key conforming to the "db.operation.batch.size" semantic conventions. It represents the number of queries included in a batch operation.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBOperationNameKey is the attribute Key conforming to the "db.operation.name" semantic conventions. It represents the name of the operation or command being executed.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBQueryTextKey is the attribute Key conforming to the "db.query.text" semantic conventions. It represents the database query being executed.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBResponseStatusCodeKey is the attribute Key conforming to the "db.response.status_code" semantic conventions. It represents the database response status code.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DBSystemKey is the attribute Key conforming to the "db.system" semantic conventions. It represents the database management system (DBMS) product as identified by the client instrumentation.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
const (
	// DeploymentEnvironmentNameKey is the attribute Key conforming to the "deployment.environment.name" semantic conventions. It represents the name of the [deployment environment] (aka deployment tier).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DeploymentIDKey is the attribute Key conforming to the "deployment.id" semantic conventions. It represents the id of the deployment.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DeploymentNameKey is the attribute Key conforming to the "deployment.name" semantic conventions. It represents the name of the deployment.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DeploymentStatusKey is the attribute Key conforming to the "deployment.status" semantic conventions. It represents the status of the deployment.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
const (
	// DestinationAddressKey is the attribute Key conforming to the "destination.address" semantic conventions. It represents the destination address - domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DestinationPortKey is the attribute Key conforming to the "destination.port" semantic conventions. It represents the destination port number.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
...
const (
	...
	// DeviceManufacturerKey is the attribute Key conforming to the "device.manufacturer" semantic conventions. It represents the name of the device manufacturer.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DeviceModelIdentifierKey is the attribute Key conforming to the "device.model.identifier" semantic conventions. It represents the model identifier for the device.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// DeviceModelNameKey is the attribute Key conforming to the "device.model.name" semantic conventions. It represents the marketing name for the device model.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: disk
const (
	// DiskIoDirectionKey is the attribute Key conforming to the "disk.io.direction" semantic conventions. It represents the disk IO operation direction.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: dns
const (
	// DNSQuestionNameKey is the attribute Key conforming to the "dns.question.name" semantic conventions. It represents the name being queried.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: event
const (
	// EventNameKey is the attribute Key conforming to the "event.name" semantic conventions. It represents the identifies the class / type of event.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: exception
const (
	// ExceptionEscapedKey is the attribute Key conforming to the "exception.escaped" semantic conventions. It represents the sHOULD be set to true if the exception event is recorded at a point where it is known that the exception is escaping the scope of the span.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ExceptionMessageKey is the attribute Key conforming to the "exception.message" semantic conventions. It represents the exception message.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ExceptionStacktraceKey is the attribute Key conforming to the "exception.stacktrace" semantic conventions. It represents a stacktrace as a string in the natural representation for the language runtime. The representation is to be determined and documented by each language SIG.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ExceptionTypeKey is the attribute Key conforming to the "exception.type" semantic conventions. It represents the type of the exception (its fully-qualified class name, if applicable). The dynamic type of the exception should be preferred over the static type in languages that support it.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: faas
const (
	// FaaSColdstartKey is the attribute Key conforming to the "faas.coldstart" semantic conventions. It represents a boolean that is true if the serverless function is executed for the first time (aka cold-start).
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSCronKey is the attribute Key conforming to the "faas.cron" semantic conventions. It represents a string containing the schedule period as [Cron Expression].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSDocumentCollectionKey is the attribute Key conforming to the "faas.document.collection" semantic conventions. It represents the name of the source on which the triggering operation was performed. For example, in Cloud Storage or S3 corresponds to the bucket name, and in Cosmos DB to the database name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSDocumentNameKey is the attribute Key conforming to the "faas.document.name" semantic conventions. It represents the document name/table subjected to the operation. For example, in Cloud Storage or S3 is the name of the file, and in Cosmos DB the table name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSDocumentOperationKey is the attribute Key conforming to the "faas.document.operation" semantic conventions. It represents the describes the type of the operation that was performed on the data.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSDocumentTimeKey is the attribute Key conforming to the "faas.document.time" semantic conventions. It represents a string containing the time when the data was accessed in the [ISO 8601] format expressed in [UTC].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSInstanceKey is the attribute Key conforming to the "faas.instance" semantic conventions. It represents the execution environment ID as a string, that will be potentially reused for other invocations to the same function/function version.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSInvocationIDKey is the attribute Key conforming to the "faas.invocation_id" semantic conventions. It represents the invocation ID of the current function invocation.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSInvokedNameKey is the attribute Key conforming to the "faas.invoked_name" semantic conventions. It represents the name of the invoked function.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSInvokedProviderKey is the attribute Key conforming to the "faas.invoked_provider" semantic conventions. It represents the cloud provider of the invoked function.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSInvokedRegionKey is the attribute Key conforming to the "faas.invoked_region" semantic conventions. It represents the cloud region of the invoked function.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSMaxMemoryKey is the attribute Key conforming to the "faas.max_memory" semantic conventions. It represents the amount of memory available to the serverless function converted to Bytes.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSNameKey is the attribute Key conforming to the "faas.name" semantic conventions. It represents the name of the single function that this runtime instance executes.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSTimeKey is the attribute Key conforming to the "faas.time" semantic conventions. It represents a string containing the function invocation time in the [ISO 8601] format expressed in [UTC].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSTriggerKey is the attribute Key conforming to the "faas.trigger" semantic conventions. It represents the type of the trigger which caused this function invocation.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FaaSVersionKey is the attribute Key conforming to the "faas.version" semantic conventions. It represents the immutable version of the function being executed.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
const (
	// FeatureFlagKeyKey is the attribute Key conforming to the "feature_flag.key" semantic conventions. It represents the unique identifier of the feature flag.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FeatureFlagProviderNameKey is the attribute Key conforming to the "feature_flag.provider_name" semantic conventions. It represents the name of the service provider that performs the flag evaluation.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FeatureFlagVariantKey is the attribute Key conforming to the "feature_flag.variant" semantic conventions. It represents the sHOULD be a semantic identifier for a value. If one is unavailable, a stringified version of the value can be used.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: file
const (
	// FileAccessedKey is the attribute Key conforming to the "file.accessed" semantic conventions. It represents the time when the file was last accessed, in ISO 8601 format.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileAttributesKey is the attribute Key conforming to the "file.attributes" semantic conventions. It represents the array of file attributes.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileChangedKey is the attribute Key conforming to the "file.changed" semantic conventions. It represents the time when the file attributes or metadata was last changed, in ISO 8601 format.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileCreatedKey is the attribute Key conforming to the "file.created" semantic conventions. It represents the time when the file was created, in ISO 8601 format.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileDirectoryKey is the attribute Key conforming to the "file.directory" semantic conventions. It represents the directory where the file is located. It should include the drive letter, when appropriate.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileExtensionKey is the attribute Key conforming to the "file.extension" semantic conventions. It represents the file extension, excluding the leading dot.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileForkNameKey is the attribute Key conforming to the "file.fork_name" semantic conventions. It represents the name of the fork. A fork is additional data associated with a filesystem object.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileGroupIDKey is the attribute Key conforming to the "file.group.id" semantic conventions. It represents the primary Group ID (GID) of the file.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileGroupNameKey is the attribute Key conforming to the "file.group.name" semantic conventions. It represents the primary group name of the file.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileInodeKey is the attribute Key conforming to the "file.inode" semantic conventions. It represents the inode representing the file in the filesystem.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileModeKey is the attribute Key conforming to the "file.mode" semantic conventions. It represents the mode of the file in octal representation.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileModifiedKey is the attribute Key conforming to the "file.modified" semantic conventions. It represents the time when the file content was last modified, in ISO 8601 format.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileNameKey is the attribute Key conforming to the "file.name" semantic conventions. It represents the name of the file including the extension, without the directory.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileOwnerIDKey is the attribute Key conforming to the "file.owner.id" semantic conventions. It represents the user ID (UID) or security identifier (SID) of the file owner.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileOwnerNameKey is the attribute Key conforming to the "file.owner.name" semantic conventions. It represents the username of the file owner.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FilePathKey is the attribute Key conforming to the "file.path" semantic conventions. It represents the full path to the file, including the file name. It should include the drive letter, when appropriate.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileSizeKey is the attribute Key conforming to the "file.size" semantic conventions. It represents the file size in bytes.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// FileSymbolicLinkTargetPathKey is the attribute Key conforming to the "file.symbolic_link.target_path" semantic conventions. It represents the path to the target of a symbolic link.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: gcp
const (
	// GCPClientServiceKey is the attribute Key conforming to the "gcp.client.service" semantic conventions. It represents the identifies the Google Cloud service for which the official client library is intended.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GCPCloudRunJobExecutionKey is the attribute Key conforming to the "gcp.cloud_run.job.execution" semantic conventions. It represents the name of the Cloud Run [execution] being run for the Job, as set by the [`CLOUD_RUN_EXECUTION`] environment variable.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GCPCloudRunJobTaskIndexKey is the attribute Key conforming to the "gcp.cloud_run.job.task_index" semantic conventions. It represents the index for a task within an execution as provided by the [`CLOUD_RUN_TASK_INDEX`] environment variable.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GCPGceInstanceHostnameKey is the attribute Key conforming to the "gcp.gce.instance.hostname" semantic conventions. It represents the hostname of a GCE instance. This is the full value of the default or [custom hostname].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GCPGceInstanceNameKey is the attribute Key conforming to the "gcp.gce.instance.name" semantic conventions. It represents the instance name of a GCE instance. This is the value provided by `host.name`, the visible name of the instance in the Cloud Console UI, and the prefix for the default hostname of the instance as defined by the [default internal DNS name].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: gen_ai
const (
	// GenAIOpenaiRequestResponseFormatKey is the attribute Key conforming to the "gen_ai.openai.request.response_format" semantic conventions. It represents the response format that is requested.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIOpenaiRequestSeedKey is the attribute Key conforming to the "gen_ai.openai.request.seed" semantic conventions. It represents the requests with same seed value more likely to return same result.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIOpenaiRequestServiceTierKey is the attribute Key conforming to the "gen_ai.openai.request.service_tier" semantic conventions. It represents the service tier requested. May be a specific tier, detault, or auto.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIOpenaiResponseServiceTierKey is the attribute Key conforming to the "gen_ai.openai.response.service_tier" semantic conventions. It represents the service tier used for the response.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIOperationNameKey is the attribute Key conforming to the "gen_ai.operation.name" semantic conventions. It represents the name of the operation being performed.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestFrequencyPenaltyKey is the attribute Key conforming to the "gen_ai.request.frequency_penalty" semantic conventions. It represents the frequency penalty setting for the GenAI request.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestMaxTokensKey is the attribute Key conforming to the "gen_ai.request.max_tokens" semantic conventions. It represents the maximum number of tokens the model generates for a request.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestModelKey is the attribute Key conforming to the "gen_ai.request.model" semantic conventions. It represents the name of the GenAI model a request is being made to.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestPresencePenaltyKey is the attribute Key conforming to the "gen_ai.request.presence_penalty" semantic conventions. It represents the presence penalty setting for the GenAI request.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestStopSequencesKey is the attribute Key conforming to the "gen_ai.request.stop_sequences" semantic conventions. It represents the list of sequences that the model will use to stop generating further tokens.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestTemperatureKey is the attribute Key conforming to the "gen_ai.request.temperature" semantic conventions. It represents the temperature setting for the GenAI request.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestTopKKey is the attribute Key conforming to the "gen_ai.request.top_k" semantic conventions. It represents the top_k sampling setting for the GenAI request.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIRequestTopPKey is the attribute Key conforming to the "gen_ai.request.top_p" semantic conventions. It represents the top_p sampling setting for the GenAI request.
	// 
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIResponseFinishReasonsKey is the attribute Key conforming to the "gen_ai.response.finish_reasons" semantic conventions. It represents the array of reasons the model stopped generating tokens, corresponding to each generation received.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIResponseIDKey is the attribute Key conforming to the "gen_ai.response.id" semantic conventions. It represents the unique identifier for the completion.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIResponseModelKey is the attribute Key conforming to the "gen_ai.response.model" semantic conventions. It represents the name of the model that generated the response.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAISystemKey is the attribute Key conforming to the "gen_ai.system" semantic conventions. It represents the Generative AI product as identified by the client or server instrumentation.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAITokenTypeKey is the attribute Key conforming to the "gen_ai.token.type" semantic conventions. It represents the type of token being counted.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIUsageInputTokensKey is the attribute Key conforming to the "gen_ai.usage.input_tokens" semantic conventions. It represents the number of tokens used in the GenAI input (prompt).
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GenAIUsageOutputTokensKey is the attribute Key conforming to the "gen_ai.usage.output_tokens" semantic conventions. It represents the number of tokens used in the GenAI response (completion).
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: go
const (
	// GoMemoryTypeKey is the attribute Key conforming to the "go.memory.type" semantic conventions. It represents the type of memory.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: graphql
const (
	// GraphqlDocumentKey is the attribute Key conforming to the "graphql.document" semantic conventions. It represents the GraphQL document being executed.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GraphqlOperationNameKey is the attribute Key conforming to the "graphql.operation.name" semantic conventions. It represents the name of the operation being executed.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// GraphqlOperationTypeKey is the attribute Key conforming to the "graphql.operation.type" semantic conventions. It represents the type of the operation being executed.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: heroku
const (
	// HerokuAppIDKey is the attribute Key conforming to the "heroku.app.id" semantic conventions. It represents the unique identifier for the application.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HerokuReleaseCommitKey is the attribute Key conforming to the "heroku.release.commit" semantic conventions. It represents the commit hash for the current release.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HerokuReleaseCreationTimestampKey is the attribute Key conforming to the "heroku.release.creation_timestamp" semantic conventions. It represents the time and date the release was created.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: host
const (
	// HostArchKey is the attribute Key conforming to the "host.arch" semantic conventions. It represents the CPU architecture the host system is running on.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostCPUCacheL2SizeKey is the attribute Key conforming to the "host.cpu.cache.l2.size" semantic conventions. It represents the amount of level 2 memory cache available to the processor (in Bytes).
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostCPUFamilyKey is the attribute Key conforming to the "host.cpu.family" semantic conventions. It represents the family or generation of the CPU.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostCPUModelIDKey is the attribute Key conforming to the "host.cpu.model.id" semantic conventions. It represents the model identifier. It provides more granular information about the CPU, distinguishing it from other CPUs within the same family.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostCPUModelNameKey is the attribute Key conforming to the "host.cpu.model.name" semantic conventions. It represents the model designation of the processor.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostCPUSteppingKey is the attribute Key conforming to the "host.cpu.stepping" semantic conventions. It represents the stepping or core revisions.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostCPUVendorIDKey is the attribute Key conforming to the "host.cpu.vendor.id" semantic conventions. It represents the processor manufacturer identifier. A maximum 12-character string.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostImageIDKey is the attribute Key conforming to the "host.image.id" semantic conventions. It represents the vM image ID or host OS image ID. For Cloud, this value is from the provider.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostImageNameKey is the attribute Key conforming to the "host.image.name" semantic conventions. It represents the name of the VM image or OS install the host was instantiated from.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostImageVersionKey is the attribute Key conforming to the "host.image.version" semantic conventions. It represents the version string of the VM image or host OS as defined in [Version Attributes].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostIPKey is the attribute Key conforming to the "host.ip" semantic conventions. It represents the available IP addresses of the host, excluding loopback interfaces.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostMacKey is the attribute Key conforming to the "host.mac" semantic conventions. It represents the available MAC addresses of the host, excluding loopback interfaces.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostNameKey is the attribute Key conforming to the "host.name" semantic conventions. It represents the name of the host. On Unix systems, it may contain what the hostname command returns, or the fully qualified hostname, or another name specified by the user.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HostTypeKey is the attribute Key conforming to the "host.type" semantic conventions. It represents the type of host. For Cloud, this must be the machine type.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: http
const (
	// HTTPConnectionStateKey is the attribute Key conforming to the "http.connection.state" semantic conventions. It represents the state of the HTTP connection in the HTTP connection pool.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HTTPRequestMethodOriginalKey is the attribute Key conforming to the "http.request.method_original" semantic conventions. It represents the original HTTP method sent by the client in the request line.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// HTTPRequestResendCountKey is the attribute Key conforming to the "http.request.resend_count" semantic conventions. It represents the ordinal number of request resending attempt (for any reason, including redirects).
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// HTTPResponseSizeKey is the attribute Key conforming to the "http.response.size" semantic conventions. It represents the total size of the response in bytes. This should be the total number of bytes sent over the wire, including the status line (HTTP/1.1), framing (HTTP/2 and HTTP/3), headers, and response body and trailers if any.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HTTPResponseStatusCodeKey is the attribute Key conforming to the "http.response.status_code" semantic conventions. It represents the [HTTP response status code].
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// HTTPRouteKey is the attribute Key conforming to the "http.route" semantic conventions. It represents the matched route, that is, the path template in the format used by the respective server framework.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: hw
const (
	// HwIDKey is the attribute Key conforming to the "hw.id" semantic conventions. It represents an identifier for the hardware component, unique within the monitored host.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HwNameKey is the attribute Key conforming to the "hw.name" semantic conventions. It represents an easily-recognizable name for the hardware component.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HwParentKey is the attribute Key conforming to the "hw.parent" semantic conventions. It represents the unique identifier of the parent component (typically the `hw.id` attribute of the enclosure, or disk controller).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HwStateKey is the attribute Key conforming to the "hw.state" semantic conventions. It represents the current state of the component.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// HwTypeKey is the attribute Key conforming to the "hw.type" semantic conventions. It represents the type of the component.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: jvm
const (
	// JVMBufferPoolNameKey is the attribute Key conforming to the "jvm.buffer.pool.name" semantic conventions. It represents the name of the buffer pool.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// JVMGCActionKey is the attribute Key conforming to the "jvm.gc.action" semantic conventions. It represents the name of the garbage collector action.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMGCNameKey is the attribute Key conforming to the "jvm.gc.name" semantic conventions. It represents the name of the garbage collector.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMMemoryPoolNameKey is the attribute Key conforming to the "jvm.memory.pool.name" semantic conventions. It represents the name of the memory pool.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMMemoryTypeKey is the attribute Key conforming to the "jvm.memory.type" semantic conventions. It represents the type of memory.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMThreadDaemonKey is the attribute Key conforming to the "jvm.thread.daemon" semantic conventions. It represents the whether the thread is daemon or not.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMThreadStateKey is the attribute Key conforming to the "jvm.thread.state" semantic conventions. It represents the state of the thread.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: k8s
const (
	// K8SClusterNameKey is the attribute Key conforming to the "k8s.cluster.name" semantic conventions. It represents the name of the cluster.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SClusterUIDKey is the attribute Key conforming to the "k8s.cluster.uid" semantic conventions. It represents a pseudo-ID for the cluster, set to the UID of the `kube-system` namespace.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SContainerNameKey is the attribute Key conforming to the "k8s.container.name" semantic conventions. It represents the name of the Container from Pod specification, must be unique within a Pod. Container runtime usually uses different globally unique name (`container.name`).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SContainerRestartCountKey is the attribute Key conforming to the "k8s.container.restart_count" semantic conventions. It represents the number of times the container was restarted. This attribute can be used to identify a particular container (running or stopped) within a container spec.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SContainerStatusLastTerminatedReasonKey is the attribute Key conforming to the "k8s.container.status.last_terminated_reason" semantic conventions. It represents the last terminated reason of the Container.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SCronJobNameKey is the attribute Key conforming to the "k8s.cronjob.name" semantic conventions. It represents the name of the CronJob.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SCronJobUIDKey is the attribute Key conforming to the "k8s.cronjob.uid" semantic conventions. It represents the UID of the CronJob.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SDaemonSetNameKey is the attribute Key conforming to the "k8s.daemonset.name" semantic conventions. It represents the name of the DaemonSet.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SDaemonSetUIDKey is the attribute Key conforming to the "k8s.daemonset.uid" semantic conventions. It represents the UID of the DaemonSet.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SDeploymentNameKey is the attribute Key conforming to the "k8s.deployment.name" semantic conventions. It represents the name of the Deployment.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SDeploymentUIDKey is the attribute Key conforming to the "k8s.deployment.uid" semantic conventions. It represents the UID of the Deployment.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SNamespaceNameKey is the attribute Key conforming to the "k8s.namespace.name" semantic conventions. It represents the name of the namespace that the pod is running in.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SReplicaSetNameKey is the attribute Key conforming to the "k8s.replicaset.name" semantic conventions. It represents the name of the ReplicaSet.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SReplicaSetUIDKey is the attribute Key conforming to the "k8s.replicaset.uid" semantic conventions. It represents the UID of the ReplicaSet.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SStatefulSetNameKey is the attribute Key conforming to the "k8s.statefulset.name" semantic conventions. It represents the name of the StatefulSet.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SStatefulSetUIDKey is the attribute Key conforming to the "k8s.statefulset.uid" semantic conventions. It represents the UID of the StatefulSet.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SVolumeNameKey is the attribute Key conforming to the "k8s.volume.name" semantic conventions. It represents the name of the K8s volume.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// K8SVolumeTypeKey is the attribute Key conforming to the "k8s.volume.type" semantic conventions. It represents the type of the K8s volume.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: linux
const (
	// LinuxMemorySlabStateKey is the attribute Key conforming to the "linux.memory.slab.state" semantic conventions. It represents the Linux Slab memory state.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: log
const (
	// LogFileNameKey is the attribute Key conforming to the "log.file.name" semantic conventions. It represents the basename of the file.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// LogFileNameResolvedKey is the attribute Key conforming to the "log.file.name_resolved" semantic conventions. It represents the basename of the file, with symlinks resolved.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// LogFilePathKey is the attribute Key conforming to the "log.file.path" semantic conventions. It represents the full path to the file.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// LogFilePathResolvedKey is the attribute Key conforming to the "log.file.path_resolved" semantic conventions. It represents the full path to the file, with symlinks resolved.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// LogIostreamKey is the attribute Key conforming to the "log.iostream" semantic conventions. It represents the stream associated with the log. See below for a list of well-known values.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// LogRecordOriginalKey is the attribute Key conforming to the "log.record.original" semantic conventions. It represents the complete original Log Record.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "77 <86>1 2015-08-06T21:58:59.694Z 192.168.2.133 inactive - - - Something happened", "[INFO] 8/3/24 12:34:56 Something happened"
	...
	// LogRecordUIDKey is the attribute Key conforming to the "log.record.uid" semantic conventions. It represents a unique identifier for the Log Record.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: messaging
const (
	// MessagingBatchMessageCountKey is the attribute Key conforming to the "messaging.batch.message_count" semantic conventions. It represents the number of messages sent, received, or processed in the scope of the batching operation.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingClientIDKey is the attribute Key conforming to the "messaging.client.id" semantic conventions. It represents a unique identifier for the client that consumes or produces a message.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingConsumerGroupNameKey is the attribute Key conforming to the "messaging.consumer.group.name" semantic conventions. It represents the name of the consumer group with which a consumer is associated.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingDestinationAnonymousKey is the attribute Key conforming to the "messaging.destination.anonymous" semantic conventions. It represents a boolean that is true if the message destination is anonymous (could be unnamed or have auto-generated name).
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingDestinationNameKey is the attribute Key conforming to the "messaging.destination.name" semantic conventions. It represents the message destination name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingDestinationPartitionIDKey is the attribute Key conforming to the "messaging.destination.partition.id" semantic conventions. It represents the identifier of the partition messages are sent to or received from, unique within the `messaging.destination.name`.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingDestinationSubscriptionNameKey is the attribute Key conforming to the "messaging.destination.subscription.name" semantic conventions. It represents the name of the destination subscription from which a message is consumed.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingDestinationTemplateKey is the attribute Key conforming to the "messaging.destination.template" semantic conventions. It represents the low cardinality representation of the messaging destination name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingDestinationTemporaryKey is the attribute Key conforming to the "messaging.destination.temporary" semantic conventions. It represents a boolean that is true if the message destination is temporary and might not exist anymore after messages are processed.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingEventhubsMessageEnqueuedTimeKey is the attribute Key conforming to the "messaging.eventhubs.message.enqueued_time" semantic conventions. It represents the UTC epoch seconds at which the message has been accepted and stored in the entity.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingGCPPubsubMessageAckDeadlineKey is the attribute Key conforming to the "messaging.gcp_pubsub.message.ack_deadline" semantic conventions. It represents the ack deadline in seconds set for the modify ack deadline request.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingGCPPubsubMessageAckIDKey is the attribute Key conforming to the "messaging.gcp_pubsub.message.ack_id" semantic conventions. It represents the ack id for a given message.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingGCPPubsubMessageDeliveryAttemptKey is the attribute Key conforming to the "messaging.gcp_pubsub.message.delivery_attempt" semantic conventions. It represents the delivery attempt for a given message.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingGCPPubsubMessageOrderingKeyKey is the attribute Key conforming to the "messaging.gcp_pubsub.message.ordering_key" semantic conventions. It represents the ordering key for a given message. If the attribute is not present, the message does not have an ordering key.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingKafkaMessageTombstoneKey is the attribute Key conforming to the "messaging.kafka.message.tombstone" semantic conventions. It represents a boolean that is true if the message is a tombstone.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingKafkaOffsetKey is the attribute Key conforming to the "messaging.kafka.offset" semantic conventions. It represents the offset of a record in the corresponding Kafka partition.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingMessageBodySizeKey is the attribute Key conforming to the "messaging.message.body.size" semantic conventions. It represents the size of the message body in bytes.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingMessageConversationIDKey is the attribute Key conforming to the "messaging.message.conversation_id" semantic conventions. It represents the conversation ID identifying the conversation to which the message belongs, represented as a string. Sometimes called "Correlation ID".
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingMessageEnvelopeSizeKey is the attribute Key conforming to the "messaging.message.envelope.size" semantic conventions. It represents the size of the message body and metadata in bytes.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingMessageIDKey is the attribute Key conforming to the "messaging.message.id" semantic conventions. It represents a value used by the messaging system as an identifier for the message, represented as a string.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingOperationNameKey is the attribute Key conforming to the "messaging.operation.name" semantic conventions. It represents the system-specific name of the messaging operation.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingOperationTypeKey is the attribute Key conforming to the "messaging.operation.type" semantic conventions. It represents a string identifying the type of the messaging operation.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRabbitmqDestinationRoutingKeyKey is the attribute Key conforming to the "messaging.rabbitmq.destination.routing_key" semantic conventions. It represents the rabbitMQ message routing key.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRabbitmqMessageDeliveryTagKey is the attribute Key conforming to the "messaging.rabbitmq.message.delivery_tag" semantic conventions. It represents the rabbitMQ message delivery tag.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqConsumptionModelKey is the attribute Key conforming to the "messaging.rocketmq.consumption_model" semantic conventions. It represents the model of message consumption. This only applies to consumer spans.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqMessageDelayTimeLevelKey is the attribute Key conforming to the "messaging.rocketmq.message.delay_time_level" semantic conventions. It represents the delay time level for delay message, which determines the message delay time.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqMessageDeliveryTimestampKey is the attribute Key conforming to the "messaging.rocketmq.message.delivery_timestamp" semantic conventions. It represents the timestamp in milliseconds that the delay message is expected to be delivered to consumer.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqMessageGroupKey is the attribute Key conforming to the "messaging.rocketmq.message.group" semantic conventions. It represents the it is essential for FIFO message. Messages that belong to the same message group are always processed one by one within the same consumer group.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqMessageKeysKey is the attribute Key conforming to the "messaging.rocketmq.message.keys" semantic conventions. It represents the key(s) of message, another way to mark message besides message id.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqMessageTagKey is the attribute Key conforming to the "messaging.rocketmq.message.tag" semantic conventions. It represents the secondary classifier of message besides topic.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqMessageTypeKey is the attribute Key conforming to the "messaging.rocketmq.message.type" semantic conventions. It represents the type of message.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingRocketmqNamespaceKey is the attribute Key conforming to the "messaging.rocketmq.namespace" semantic conventions. It represents the namespace of RocketMQ resources, resources in different namespaces are individual.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingServicebusDispositionStatusKey is the attribute Key conforming to the "messaging.servicebus.disposition_status" semantic conventions. It represents the describes the [settlement type].
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingServicebusMessageDeliveryCountKey is the attribute Key conforming to the "messaging.servicebus.message.delivery_count" semantic conventions. It represents the number of deliveries that have been attempted for this message.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingServicebusMessageEnqueuedTimeKey is the attribute Key conforming to the "messaging.servicebus.message.enqueued_time" semantic conventions. It represents the UTC epoch seconds at which the message has been accepted and stored in the entity.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// MessagingSystemKey is the attribute Key conforming to the "messaging.system" semantic conventions. It represents the messaging system as identified by the client instrumentation.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: network
const (
	// NetworkCarrierIccKey is the attribute Key conforming to the "network.carrier.icc" semantic conventions. It represents the ISO 3166-1 alpha-2 2-character country code associated with the mobile carrier network.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// NetworkCarrierMccKey is the attribute Key conforming to the "network.carrier.mcc" semantic conventions. It represents the mobile carrier country code.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// NetworkCarrierMncKey is the attribute Key conforming to the "network.carrier.mnc" semantic conventions. It represents the mobile carrier network code.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// NetworkCarrierNameKey is the attribute Key conforming to the "network.carrier.name" semantic conventions. It represents the name of the mobile carrier.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// NetworkConnectionTypeKey is the attribute Key conforming to the "network.connection.type" semantic conventions. It represents the internet connection type.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// NetworkIoDirectionKey is the attribute Key conforming to the "network.io.direction" semantic conventions. It represents the network IO operation direction.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// NetworkLocalAddressKey is the attribute Key conforming to the "network.local.address" semantic conventions. It represents the local address of the network connection - IP address or Unix domain socket name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// NetworkLocalPortKey is the attribute Key conforming to the "network.local.port" semantic conventions. It represents the local port number of the network connection.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// NetworkPeerAddressKey is the attribute Key conforming to the "network.peer.address" semantic conventions. It represents the peer address of the network connection - IP address or Unix domain socket name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// NetworkPeerPortKey is the attribute Key conforming to the "network.peer.port" semantic conventions. It represents the peer port number of the network connection.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// NetworkProtocolNameKey is the attribute Key conforming to the "network.protocol.name" semantic conventions. It represents the [OSI application layer] or non-OSI equivalent.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// NetworkProtocolVersionKey is the attribute Key conforming to the "network.protocol.version" semantic conventions. It represents the actual version of the protocol used for network communication.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// NetworkTransportKey is the attribute Key conforming to the "network.transport" semantic conventions. It represents the [OSI transport layer] or [inter-process communication method].
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// NetworkTypeKey is the attribute Key conforming to the "network.type" semantic conventions. It represents the [OSI network layer] or non-OSI equivalent.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
...
const (
	// OpentracingRefTypeKey is the attribute Key conforming to the "opentracing.ref_type" semantic conventions. It represents the parent-child Reference type.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: os
const (
	// OSBuildIDKey is the attribute Key conforming to the "os.build_id" semantic conventions. It represents the unique identifier for a particular build or compilation of the operating system.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// OSDescriptionKey is the attribute Key conforming to the "os.description" semantic conventions. It represents the human readable (not intended to be parsed) OS version information, like e.g. reported by `ver` or `lsb_release -a` commands.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// OSVersionKey is the attribute Key conforming to the "os.version" semantic conventions. It represents the version string of the operating system as defined in [Version Attributes].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: otel
const (
	// OTelScopeNameKey is the attribute Key conforming to the "otel.scope.name" semantic conventions. It represents the name of the instrumentation scope - (`InstrumentationScope.Name` in OTLP).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// OTelScopeVersionKey is the attribute Key conforming to the "otel.scope.version" semantic conventions. It represents the version of the instrumentation scope - (`InstrumentationScope.Version` in OTLP).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// OTelStatusCodeKey is the attribute Key conforming to the "otel.status_code" semantic conventions. It represents the name of the code, either "OK" or "ERROR". MUST NOT be set if the status code is UNSET.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// OTelStatusDescriptionKey is the attribute Key conforming to the "otel.status_description" semantic conventions. It represents the description of the Status if it has a value, otherwise not set.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: peer
const (
	// PeerServiceKey is the attribute Key conforming to the "peer.service" semantic conventions. It represents the [`service.name`] of the remote service. SHOULD be equal to the actual `service.name` resource attribute of the remote service if any.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: process
const (
	// ProcessArgsCountKey is the attribute Key conforming to the "process.args_count" semantic conventions. It represents the length of the process.command_args array.
	// 
	// Type: int
	...
	// ProcessCommandLineKey is the attribute Key conforming to the "process.command_line" semantic conventions. It represents the full command used to launch the process as a single string representing the full command. On Windows, can be set to the result of `GetCommandLineW`. Do not set this if you have to assemble it just for monitoring; use `process.command_args` instead.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessContextSwitchTypeKey is the attribute Key conforming to the "process.context_switch_type" semantic conventions. It represents the specifies whether the context switches for this data point were voluntary or involuntary.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessCreationTimeKey is the attribute Key conforming to the "process.creation.time" semantic conventions. It represents the date and time the process was created, in ISO 8601 format.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessExecutableBuildIDGnuKey is the attribute Key conforming to the "process.executable.build_id.gnu" semantic conventions. It represents the GNU build ID as found in the `.note.gnu.build-id` ELF section (hex string).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessExecutableBuildIDGoKey is the attribute Key conforming to the "process.executable.build_id.go" semantic conventions. It represents the Go build ID as retrieved by `go tool buildid <go executable>`.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessExecutableBuildIDProfilingKey is the attribute Key conforming to the "process.executable.build_id.profiling" semantic conventions. It represents the profiling specific build ID for executables. See the OTel specification for Profiles for more information.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessExecutableNameKey is the attribute Key conforming to the "process.executable.name" semantic conventions. It represents the name of the process executable. On Linux based systems, can be set to the `Name` in `proc/[pid]/status`. On Windows, can be set to the base name of `GetProcessImageFileNameW`.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessExecutablePathKey is the attribute Key conforming to the "process.executable.path" semantic conventions. It represents the full path to the process executable. On Linux based systems, can be set to the target of `proc/[pid]/exe`. On Windows, can be set to the result of `GetProcessImageFileNameW`.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessExitCodeKey is the attribute Key conforming to the "process.exit.code" semantic conventions. It represents the exit code of the process.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessExitTimeKey is the attribute Key conforming to the "process.exit.time" semantic conventions. It represents the date and time the process exited, in ISO 8601 format.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessGroupLeaderPIDKey is the attribute Key conforming to the "process.group_leader.pid" semantic conventions. It represents the PID of the process's group leader. This is also the process group ID (PGID) of the process.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessInteractiveKey is the attribute Key conforming to the "process.interactive" semantic conventions. It represents the whether the process is connected to an interactive shell.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessOwnerKey is the attribute Key conforming to the "process.owner" semantic conventions. It represents the username of the user that owns the process.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessPagingFaultTypeKey is the attribute Key conforming to the "process.paging.fault_type" semantic conventions. It represents the type of page fault for this data point. Type `major` is for major/hard page faults, and `minor` is for minor/soft page faults.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessParentPIDKey is the attribute Key conforming to the "process.parent_pid" semantic conventions. It represents the parent Process identifier (PPID).
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessRealUserIDKey is the attribute Key conforming to the "process.real_user.id" semantic conventions. It represents the real user ID (RUID) of the process.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessRealUserNameKey is the attribute Key conforming to the "process.real_user.name" semantic conventions. It represents the username of the real user of the process.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessRuntimeDescriptionKey is the attribute Key conforming to the "process.runtime.description" semantic conventions. It represents an additional description about the runtime of the process, for example a specific vendor customization of the runtime environment.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessRuntimeNameKey is the attribute Key conforming to the "process.runtime.name" semantic conventions. It represents the name of the runtime of this process.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessRuntimeVersionKey is the attribute Key conforming to the "process.runtime.version" semantic conventions. It represents the version of the runtime of this process, as returned by the runtime without modification.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessSavedUserIDKey is the attribute Key conforming to the "process.saved_user.id" semantic conventions. It represents the saved user ID (SUID) of the process.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessSavedUserNameKey is the attribute Key conforming to the "process.saved_user.name" semantic conventions. It represents the username of the saved user.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessSessionLeaderPIDKey is the attribute Key conforming to the "process.session_leader.pid" semantic conventions. It represents the PID of the process's session leader. This is also the session ID (SID) of the process.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessTitleKey is the attribute Key conforming to the "process.title" semantic conventions. It represents the process title (proctitle).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessUserIDKey is the attribute Key conforming to the "process.user.id" semantic conventions. It represents the effective user ID (EUID) of the process.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessUserNameKey is the attribute Key conforming to the "process.user.name" semantic conventions. It represents the username of the effective user of the process.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessVpidKey is the attribute Key conforming to the "process.vpid" semantic conventions. It represents the virtual process identifier.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ProcessWorkingDirectoryKey is the attribute Key conforming to the "process.working_directory" semantic conventions. It represents the working directory of the process.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: profile
const (
	// ProfileFrameTypeKey is the attribute Key conforming to the "profile.frame.type" semantic conventions. It represents the describes the interpreter or compiler of a single frame.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: rpc
const (
	// RPCConnectRPCErrorCodeKey is the attribute Key conforming to the "rpc.connect_rpc.error_code" semantic conventions. It represents the [error codes] of the Connect request. Error codes are always string values.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCGRPCStatusCodeKey is the attribute Key conforming to the "rpc.grpc.status_code" semantic conventions. It represents the [numeric status code] of the gRPC request.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCJsonrpcErrorCodeKey is the attribute Key conforming to the "rpc.jsonrpc.error_code" semantic conventions. It represents the `error.code` property of response if it is an error response.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCJsonrpcErrorMessageKey is the attribute Key conforming to the "rpc.jsonrpc.error_message" semantic conventions. It represents the `error.message` property of response if it is an error response.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCJsonrpcRequestIDKey is the attribute Key conforming to the "rpc.jsonrpc.request_id" semantic conventions. It represents the `id` property of request or response. Since protocol allows id to be int, string, `null` or missing (for notifications), value is expected to be cast to string for simplicity. Use empty string in case of `null` value. Omit entirely if this is a notification.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCJsonrpcVersionKey is the attribute Key conforming to the "rpc.jsonrpc.version" semantic conventions. It represents the protocol version as in `jsonrpc` property of request/response. Since JSON-RPC 1.0 doesn't specify this, the value can be omitted.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCMessageCompressedSizeKey is the attribute Key conforming to the "rpc.message.compressed_size" semantic conventions. It represents the compressed size of the message in bytes.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCMessageIDKey is the attribute Key conforming to the "rpc.message.id" semantic conventions. It represents the mUST be calculated as two different counters starting from `1` one for sent messages and one for received message.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCMessageTypeKey is the attribute Key conforming to the "rpc.message.type" semantic conventions. It represents the whether this is a received or sent message.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCMessageUncompressedSizeKey is the attribute Key conforming to the "rpc.message.uncompressed_size" semantic conventions. It represents the uncompressed size of the message in bytes.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCMethodKey is the attribute Key conforming to the "rpc.method" semantic conventions. It represents the name of the (logical) method being called, must be equal to the $method part in the span name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCServiceKey is the attribute Key conforming to the "rpc.service" semantic conventions. It represents the full (logical) name of the service being called, including its package name, if applicable.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// RPCSystemKey is the attribute Key conforming to the "rpc.system" semantic conventions. It represents a string identifying the remoting system. See below for a list of well-known identifiers.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: server
const (
	// ServerAddressKey is the attribute Key conforming to the "server.address" semantic conventions. It represents the server domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ServerPortKey is the attribute Key conforming to the "server.port" semantic conventions. It represents the server port number.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: service
const (
	// ServiceInstanceIDKey is the attribute Key conforming to the "service.instance.id" semantic conventions. It represents the string ID of the service instance.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ServiceNamespaceKey is the attribute Key conforming to the "service.namespace" semantic conventions. It represents a namespace for `service.name`.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// ServiceVersionKey is the attribute Key conforming to the "service.version" semantic conventions. It represents the version string of the service API or implementation. The format is not defined by these conventions.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: session
const (
	// SessionIDKey is the attribute Key conforming to the "session.id" semantic conventions. It represents a unique id to identify a session.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SessionPreviousIDKey is the attribute Key conforming to the "session.previous_id" semantic conventions. It represents the previous `session.id` for this user, when known.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: signalr
const (
	// SignalrConnectionStatusKey is the attribute Key conforming to the "signalr.connection.status" semantic conventions. It represents the signalR HTTP connection closure status.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// SignalrTransportKey is the attribute Key conforming to the "signalr.transport" semantic conventions. It represents the [SignalR transport type].
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
...
// Namespace: source
const (
	// SourceAddressKey is the attribute Key conforming to the "source.address" semantic conventions. It represents the source address - domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SourcePortKey is the attribute Key conforming to the "source.port" semantic conventions. It represents the source port number.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: system
const (
	// SystemCPULogicalNumberKey is the attribute Key conforming to the "system.cpu.logical_number" semantic conventions. It represents the logical CPU number [0..n-1].
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemDeviceKey is the attribute Key conforming to the "system.device" semantic conventions. It represents the device identifier.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemFilesystemModeKey is the attribute Key conforming to the "system.filesystem.mode" semantic conventions. It represents the filesystem mode.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemFilesystemMountpointKey is the attribute Key conforming to the "system.filesystem.mountpoint" semantic conventions. It represents the filesystem mount path.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemFilesystemStateKey is the attribute Key conforming to the "system.filesystem.state" semantic conventions. It represents the filesystem state.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemFilesystemTypeKey is the attribute Key conforming to the "system.filesystem.type" semantic conventions. It represents the filesystem type.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemMemoryStateKey is the attribute Key conforming to the "system.memory.state" semantic conventions. It represents the memory state.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemNetworkStateKey is the attribute Key conforming to the "system.network.state" semantic conventions. It represents a stateless protocol MUST NOT set this attribute.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemPagingDirectionKey is the attribute Key conforming to the "system.paging.direction" semantic conventions. It represents the paging access direction.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemPagingStateKey is the attribute Key conforming to the "system.paging.state" semantic conventions. It represents the memory paging state.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemPagingTypeKey is the attribute Key conforming to the "system.paging.type" semantic conventions. It represents the memory paging type.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// SystemProcessStatusKey is the attribute Key conforming to the "system.process.status" semantic conventions. It represents the process state, e.g., [Linux Process State Codes].
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: telemetry
const (
	// TelemetryDistroNameKey is the attribute Key conforming to the "telemetry.distro.name" semantic conventions. It represents the name of the auto instrumentation agent or distribution, if used.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TelemetryDistroVersionKey is the attribute Key conforming to the "telemetry.distro.version" semantic conventions. It represents the version string of the auto instrumentation agent or distribution, if used.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TelemetrySDKLanguageKey is the attribute Key conforming to the "telemetry.sdk.language" semantic conventions. It represents the language of the telemetry SDK.
	// 
	// Type: Enum
	// RequirementLevel: Required
	// Stability: Stable
	...
	// TelemetrySDKNameKey is the attribute Key conforming to the "telemetry.sdk.name" semantic conventions. It represents the name of the telemetry SDK as defined above.
	// 
	// Type: string
	// RequirementLevel: Required
	// Stability: Stable
	...
	// TelemetrySDKVersionKey is the attribute Key conforming to the "telemetry.sdk.version" semantic conventions. It represents the version string of the telemetry SDK.
	// 
	// Type: string
	// RequirementLevel: Required
	// Stability: Stable
...
// Namespace: test
const (
	// TestCaseNameKey is the attribute Key conforming to the "test.case.name" semantic conventions. It represents the fully qualified human readable name of the [test case].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "org.example.TestCase1.test1", "example/tests/TestCase1.test1", "ExampleTestCase1_test1"
	// 
	// [test case]: https://en.wikipedia.org/wiki/Test_case
	TestCaseNameKey = attribute.Key("test.case.name")

	// TestCaseResultStatusKey is the attribute Key conforming to the "test.case.result.status" semantic conventions. It represents the status of the actual test case result from test execution.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TestSuiteNameKey is the attribute Key conforming to the "test.suite.name" semantic conventions. It represents the human readable name of a [test suite].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TestSuiteRunStatusKey is the attribute Key conforming to the "test.suite.run.status" semantic conventions. It represents the status of the test suite run.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: thread
const (
	// ThreadIDKey is the attribute Key conforming to the "thread.id" semantic conventions. It represents the current "managed" thread ID (as opposed to OS thread ID).
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: tls
const (
	// TLSCipherKey is the attribute Key conforming to the "tls.cipher" semantic conventions. It represents the string indicating the [cipher] used during the current connection.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientCertificateKey is the attribute Key conforming to the "tls.client.certificate" semantic conventions. It represents the pEM-encoded stand-alone certificate offered by the client. This is usually mutually-exclusive of `client.certificate_chain` since this value also exists in that list.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientCertificateChainKey is the attribute Key conforming to the "tls.client.certificate_chain" semantic conventions. It represents the array of PEM-encoded certificates that make up the certificate chain offered by the client. This is usually mutually-exclusive of `client.certificate` since that value should be the first certificate in the chain.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientIssuerKey is the attribute Key conforming to the "tls.client.issuer" semantic conventions. It represents the distinguished name of [subject] of the issuer of the x.509 certificate presented by the client.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientJa3Key is the attribute Key conforming to the "tls.client.ja3" semantic conventions. It represents a hash that identifies clients based on how they perform an SSL/TLS handshake.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientNotAfterKey is the attribute Key conforming to the "tls.client.not_after" semantic conventions. It represents the date/Time indicating when client certificate is no longer considered valid.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientNotBeforeKey is the attribute Key conforming to the "tls.client.not_before" semantic conventions. It represents the date/Time indicating when client certificate is first considered valid.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientSubjectKey is the attribute Key conforming to the "tls.client.subject" semantic conventions. It represents the distinguished name of subject of the x.509 certificate presented by the client.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSClientSupportedCiphersKey is the attribute Key conforming to the "tls.client.supported_ciphers" semantic conventions. It represents the array of ciphers offered by the client during the client hello.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSCurveKey is the attribute Key conforming to the "tls.curve" semantic conventions. It represents the string indicating the curve used for the given cipher, when applicable.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSEstablishedKey is the attribute Key conforming to the "tls.established" semantic conventions. It represents the boolean flag indicating if the TLS negotiation was successful and transitioned to an encrypted tunnel.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSNextProtocolKey is the attribute Key conforming to the "tls.next_protocol" semantic conventions. It represents the string indicating the protocol being tunneled. Per the values in the [IANA registry], this string should be lower case.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSProtocolNameKey is the attribute Key conforming to the "tls.protocol.name" semantic conventions. It represents the normalized lowercase protocol name parsed from original string of the negotiated [SSL/TLS protocol version].
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSProtocolVersionKey is the attribute Key conforming to the "tls.protocol.version" semantic conventions. It represents the numeric part of the version parsed from the original string of the negotiated [SSL/TLS protocol version].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSResumedKey is the attribute Key conforming to the "tls.resumed" semantic conventions. It represents the boolean flag indicating if this TLS connection was resumed from an existing TLS negotiation.
	// 
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSServerCertificateKey is the attribute Key conforming to the "tls.server.certificate" semantic conventions. It represents the pEM-encoded stand-alone certificate offered by the server. This is usually mutually-exclusive of `server.certificate_chain` since this value also exists in that list.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSServerCertificateChainKey is the attribute Key conforming to the "tls.server.certificate_chain" semantic conventions. It represents the array of PEM-encoded certificates that make up the certificate chain offered by the server. This is usually mutually-exclusive of `server.certificate` since that value should be the first certificate in the chain.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSServerIssuerKey is the attribute Key conforming to the "tls.server.issuer" semantic conventions. It represents the distinguished name of [subject] of the issuer of the x.509 certificate presented by the client.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSServerJa3sKey is the attribute Key conforming to the "tls.server.ja3s" semantic conventions. It represents a hash that identifies servers based on how they perform an SSL/TLS handshake.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSServerNotAfterKey is the attribute Key conforming to the "tls.server.not_after" semantic conventions. It represents the date/Time indicating when server certificate is no longer considered valid.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSServerNotBeforeKey is the attribute Key conforming to the "tls.server.not_before" semantic conventions. It represents the date/Time indicating when server certificate is first considered valid.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// TLSServerSubjectKey is the attribute Key conforming to the "tls.server.subject" semantic conventions. It represents the distinguished name of subject of the x.509 certificate presented by the server.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: url
const (
	// URLDomainKey is the attribute Key conforming to the "url.domain" semantic conventions. It represents the domain extracted from the `url.full`, such as "opentelemetry.io".
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// URLExtensionKey is the attribute Key conforming to the "url.extension" semantic conventions. It represents the file extension extracted from the `url.full`, excluding the leading dot.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// URLFragmentKey is the attribute Key conforming to the "url.fragment" semantic conventions. It represents the [URI fragment] component.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// URLFullKey is the attribute Key conforming to the "url.full" semantic conventions. It represents the absolute URL describing a network resource according to [RFC3986].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// URLOriginalKey is the attribute Key conforming to the "url.original" semantic conventions. It represents the unmodified original URL as seen in the event source.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// URLPathKey is the attribute Key conforming to the "url.path" semantic conventions. It represents the [URI path] component.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// URLPortKey is the attribute Key conforming to the "url.port" semantic conventions. It represents the port extracted from the `url.full`.
	// 
	// Type: int
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// URLQueryKey is the attribute Key conforming to the "url.query" semantic conventions. It represents the [URI query] component.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// URLRegisteredDomainKey is the attribute Key conforming to the "url.registered_domain" semantic conventions. It represents the highest registered url domain, stripped of the subdomain.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// URLSchemeKey is the attribute Key conforming to the "url.scheme" semantic conventions. It represents the [URI scheme] component identifying the used protocol.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// URLTemplateKey is the attribute Key conforming to the "url.template" semantic conventions. It represents the low-cardinality template of an [absolute path reference].
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// URLTopLevelDomainKey is the attribute Key conforming to the "url.top_level_domain" semantic conventions. It represents the effective top level domain (eTLD), also known as the domain suffix, is the last part of the domain name. For example, the top level domain for example.com is `com`.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: user
const (
	// UserEmailKey is the attribute Key conforming to the "user.email" semantic conventions. It represents the user email address.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// UserFullNameKey is the attribute Key conforming to the "user.full_name" semantic conventions. It represents the user's full name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// UserHashKey is the attribute Key conforming to the "user.hash" semantic conventions. It represents the unique user hash to correlate information for a user in anonymized form.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// UserIDKey is the attribute Key conforming to the "user.id" semantic conventions. It represents the unique identifier of the user.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// UserNameKey is the attribute Key conforming to the "user.name" semantic conventions. It represents the short name or login/username of the user.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// UserRolesKey is the attribute Key conforming to the "user.roles" semantic conventions. It represents the array of user roles at the time of the event.
	// 
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Experimental
...
const (
	// UserAgentNameKey is the attribute Key conforming to the "user_agent.name" semantic conventions. It represents the name of the user-agent extracted from original. Usually refers to the browser's name.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// UserAgentOriginalKey is the attribute Key conforming to the "user_agent.original" semantic conventions. It represents the value of the [HTTP User-Agent] header sent by the client.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	// 
	// Examples: "CERN-LineMode/2.15 libwww/2.17b3", "Mozilla/5.0 (iPhone; CPU iPhone OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1.2 Mobile/15E148 Safari/604.1", "YourApp/1.0.0 grpc-java-okhttp/1.27.2"
	// 
	// [HTTP User-Agent]: https://www.rfc-editor.org/rfc/rfc9110.html#field.user-agent
	UserAgentOriginalKey = attribute.Key("user_agent.original")

	// UserAgentVersionKey is the attribute Key conforming to the "user_agent.version" semantic conventions. It represents the version of the user-agent extracted from original. Usually refers to the browser's version.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: v8js
const (
	// V8JSGCTypeKey is the attribute Key conforming to the "v8js.gc.type" semantic conventions. It represents the type of garbage collection.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// V8JSHeapSpaceNameKey is the attribute Key conforming to the "v8js.heap.space.name" semantic conventions. It represents the name of the space type of heap memory.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: vcs
const (
	// VCSRepositoryChangeIDKey is the attribute Key conforming to the "vcs.repository.change.id" semantic conventions. It represents the ID of the change (pull request/merge request) if applicable. This is usually a unique (within repository) identifier generated by the VCS system.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// VCSRepositoryChangeTitleKey is the attribute Key conforming to the "vcs.repository.change.title" semantic conventions. It represents the human readable title of the change (pull request/merge request). This title is often a brief summary of the change and may get merged in to a ref as the commit summary.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "Fixes broken thing", "feat: add my new feature", "[chore] update dependency"
	VCSRepositoryChangeTitleKey = attribute.Key("vcs.repository.change.title")

	// VCSRepositoryRefNameKey is the attribute Key conforming to the "vcs.repository.ref.name" semantic conventions. It represents the name of the [reference] such as **branch** or **tag** in the repository.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// VCSRepositoryRefRevisionKey is the attribute Key conforming to the "vcs.repository.ref.revision" semantic conventions. It represents the revision, literally [revised version], The revision most often refers to a commit object in Git, or a revision number in SVN.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	// 
	// Examples: "9d59409acf479dfa0df1aa568182e43e43df8bbe28d60fcf2bc52e30068802cc", "main", "123", "HEAD"
	...
	// VCSRepositoryRefTypeKey is the attribute Key conforming to the "vcs.repository.ref.type" semantic conventions. It represents the type of the [reference] in the repository.
	// 
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// VCSRepositoryURLFullKey is the attribute Key conforming to the "vcs.repository.url.full" semantic conventions. It represents the [URL] of the repository providing the complete address in order to locate and identify the repository.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
...
// Namespace: webengine
const (
	// WebEngineDescriptionKey is the attribute Key conforming to the "webengine.description" semantic conventions. It represents the additional description of the web engine (e.g. detailed version and edition information).
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
	...
	// WebEngineVersionKey is the attribute Key conforming to the "webengine.version" semantic conventions. It represents the version of the web engine.
	// 
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Experimental
