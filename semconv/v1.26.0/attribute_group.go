...
const (
	...
	// "db.cassandra.table" semantic conventions. It represents the deprecated,
	...
	// "db.cosmosdb.container" semantic conventions. It represents the
	...
	// semantic conventions. It represents the deprecated, no general
	// replacement at this time. For Elasticsearch, use
	...
	// conventions. It represents the deprecated, use `db.namespace` instead.
	//
	// Type: string
	// RequirementLevel: Optional
	// Stability: experimental
	...
	// "db.redis.database_index" semantic conventions. It represents the
	...
	// conventions. It represents the deprecated, no replacement at this time.
	//
	// Type: string
	// RequirementLevel: Optional
	// Stability: experimental
...
// "db.cassandra.table" semantic conventions. It represents the deprecated, use
// `db.collection.name` instead.
...
// "db.cosmosdb.container" semantic conventions. It represents the deprecated,
// use `db.collection.name` instead.
...
// "db.instance.id" semantic conventions. It represents the deprecated, no
// general replacement at this time. For Elasticsearch, use
// `db.elasticsearch.node.name` instead.
...
// "db.mongodb.collection" semantic conventions. It represents the deprecated,
// use `db.collection.name` instead.
...
// "db.mssql.instance_name" semantic conventions. It represents the deprecated,
...
// "db.operation" semantic conventions. It represents the deprecated, use
// `db.operation.name` instead.
...
// semantic conventions. It represents the deprecated, use `db.collection.name`
// instead.
...
const (
	...
	// `db.client.connections.pool.name` instead.
	//
	// Type: string
	// RequirementLevel: Optional
	// Stability: experimental
	...
	// conventions. It represents the deprecated, use
	// `db.client.connections.state` instead.
	//
	// Type: Enum
	// RequirementLevel: Optional
	// Stability: experimental
...
const (
	...
	// semantic conventions. It represents the deprecated, use `client.address`
	// instead.
	//
	// Type: string
	// RequirementLevel: Optional
	...
	// HTTPHostKey is the attribute Key conforming to the "http.host" semantic
	// conventions. It represents the deprecated, use one of `server.address`,
	// `client.address` or `http.request.header.host` instead, depending on the
	// usage.
	//
	// Type: string
	// RequirementLevel: Optional
	...
	// HTTPRequestContentLengthUncompressedKey is the attribute Key conforming
	// to the "http.request_content_length_uncompressed" semantic conventions.
	...
	// HTTPResponseContentLengthUncompressedKey is the attribute Key conforming
	// to the "http.response_content_length_uncompressed" semantic conventions.
	...
	// HTTPServerNameKey is the attribute Key conforming to the
	// "http.server_name" semantic conventions. It represents the deprecated,
...
// "http.client_ip" semantic conventions. It represents the deprecated, use
// `client.address` instead.
func HTTPClientIP(val string) attribute.KeyValue {
	return HTTPClientIPKey.String(val)
}

// HTTPHost returns an attribute KeyValue conforming to the "http.host"
// semantic conventions. It represents the deprecated, use one of
// `server.address`, `client.address` or `http.request.header.host` instead,
...
// HTTPRequestContentLengthUncompressed returns an attribute KeyValue
// conforming to the "http.request_content_length_uncompressed" semantic
// conventions. It represents the deprecated, use `http.request.body.size`
// instead.
...
// HTTPResponseContentLengthUncompressed returns an attribute KeyValue
// conforming to the "http.response_content_length_uncompressed" semantic
// conventions. It represents the deprecated, use `http.response.body.size`
// instead.
...
// HTTPServerName returns an attribute KeyValue conforming to the
// "http.server_name" semantic conventions. It represents the deprecated, use
...
const (
	...
	// conventions. It represents the deprecated use the `device.app.lifecycle`
	// event definition including `ios.state` as a payload field instead.
	//
	// Type: Enum
	// RequirementLevel: Optional
	// Stability: experimental
...
const (
	...
	// "messaging.client_id" semantic conventions. It represents the
	...
	// "messaging.operation" semantic conventions. It represents the
...
// "messaging.client_id" semantic conventions. It represents the deprecated,
// use `messaging.client.id` instead.
...
// MessagingOperation returns an attribute KeyValue conforming to the
// "messaging.operation" semantic conventions. It represents the deprecated,
// use `messaging.operation.type` instead.
...
const (
	// NetHostIPKey is the attribute Key conforming to the "net.host.ip"
	// semantic conventions. It represents the deprecated, use
	...
	// NetPeerIPKey is the attribute Key conforming to the "net.peer.ip"
	// semantic conventions. It represents the deprecated, use
...
// NetHostIP returns an attribute KeyValue conforming to the "net.host.ip"
// semantic conventions. It represents the deprecated, use
// `network.local.address`.
...
// NetPeerIP returns an attribute KeyValue conforming to the "net.peer.ip"
// semantic conventions. It represents the deprecated, use
// `network.peer.address`.
...
const (
	...
	// semantic conventions. It represents the deprecated, use `rpc.message.id`
	// instead.
	//
	// Type: int
	// RequirementLevel: Optional
