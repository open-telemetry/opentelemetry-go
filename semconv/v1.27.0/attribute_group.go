...
// CloudfoundryAppId returns an attribute KeyValue conforming to the "cloudfoundry.app.id"semantic conventions
// It represents the The guid of the application
func CloudfoundryAppId(val string) attribute.KeyValue {
	return CloudfoundryAppIdKey.String(val)
}


// CloudfoundryAppInstanceId returns an attribute KeyValue conforming to the "cloudfoundry.app.instance.id"semantic conventions
// It represents the The index of the application instance. 0 when just one instance is active
func CloudfoundryAppInstanceId(val string) attribute.KeyValue {
	return CloudfoundryAppInstanceIdKey.String(val)
}


// CloudfoundryAppName returns an attribute KeyValue conforming to the "cloudfoundry.app.name"semantic conventions
// It represents the The name of the application
func CloudfoundryAppName(val string) attribute.KeyValue {
	return CloudfoundryAppNameKey.String(val)
}


// CloudfoundryOrgId returns an attribute KeyValue conforming to the "cloudfoundry.org.id"semantic conventions
// It represents the The guid of the CloudFoundry org the application is running in
func CloudfoundryOrgId(val string) attribute.KeyValue {
	return CloudfoundryOrgIdKey.String(val)
}


// CloudfoundryOrgName returns an attribute KeyValue conforming to the "cloudfoundry.org.name"semantic conventions
// It represents the The name of the CloudFoundry organization the app is running in
func CloudfoundryOrgName(val string) attribute.KeyValue {
	return CloudfoundryOrgNameKey.String(val)
}


// CloudfoundryProcessId returns an attribute KeyValue conforming to the "cloudfoundry.process.id"semantic conventions
// It represents the The UID identifying the process
func CloudfoundryProcessId(val string) attribute.KeyValue {
	return CloudfoundryProcessIdKey.String(val)
}


// CloudfoundryProcessType returns an attribute KeyValue conforming to the "cloudfoundry.process.type"semantic conventions
// It represents the The type of process
func CloudfoundryProcessType(val string) attribute.KeyValue {
	return CloudfoundryProcessTypeKey.String(val)
}


// CloudfoundrySpaceId returns an attribute KeyValue conforming to the "cloudfoundry.space.id"semantic conventions
// It represents the The guid of the CloudFoundry space the application is running in
func CloudfoundrySpaceId(val string) attribute.KeyValue {
	return CloudfoundrySpaceIdKey.String(val)
}


// CloudfoundrySpaceName returns an attribute KeyValue conforming to the "cloudfoundry.space.name"semantic conventions
// It represents the The name of the CloudFoundry space the application is running in
func CloudfoundrySpaceName(val string) attribute.KeyValue {
	return CloudfoundrySpaceNameKey.String(val)
}


// CloudfoundrySystemId returns an attribute KeyValue conforming to the "cloudfoundry.system.id"semantic conventions
// It represents the A guid or another name describing the event source
func CloudfoundrySystemId(val string) attribute.KeyValue {
	return CloudfoundrySystemIdKey.String(val)
}


// CloudfoundrySystemInstanceId returns an attribute KeyValue conforming to the "cloudfoundry.system.instance.id"semantic conventions
// It represents the A guid describing the concrete instance of the event source
...
// It represents the All the command arguments (including the command/executable itself) run by the container
...
// It represents the The full command run by the container as a single string representing the full command
...
// ContainerCsiPluginName returns an attribute KeyValue conforming to the "container.csi.plugin.name"semantic conventions
// It represents the The name of the CSI ([Container Storage Interface]) plugin used by the volume
// 
// [Container Storage Interface]: https://github.com/container-storage-interface/spec
...
// ContainerCsiVolumeId returns an attribute KeyValue conforming to the "container.csi.volume.id"semantic conventions
// It represents the The unique volume ID returned by the CSI ([Container Storage Interface]) plugin
// 
// [Container Storage Interface]: https://github.com/container-storage-interface/spec
...
// It represents the Deprecated, use `db.response.status_code` instead
...
// DbQuerySummary returns an attribute KeyValue conforming to the "db.query.summary"semantic conventions
// It represents the Low cardinality representation of a database query text
...
// DbResponseStatusCode returns an attribute KeyValue conforming to the "db.response.status_code"semantic conventions
// It represents the Database response status code
...
// FileAccessed returns an attribute KeyValue conforming to the "file.accessed"semantic conventions
// It represents the Time when the file was last accessed, in ISO 8601 format
func FileAccessed(val string) attribute.KeyValue {
	return FileAccessedKey.String(val)
}


// FileAttributes returns an attribute KeyValue conforming to the "file.attributes"semantic conventions
// It represents the Array of file attributes
func FileAttributes(val ...string) attribute.KeyValue {
	return FileAttributesKey.StringSlice(val)
}


// FileChanged returns an attribute KeyValue conforming to the "file.changed"semantic conventions
// It represents the Time when the file attributes or metadata was last changed, in ISO 8601 format
func FileChanged(val string) attribute.KeyValue {
	return FileChangedKey.String(val)
}


// FileCreated returns an attribute KeyValue conforming to the "file.created"semantic conventions
// It represents the Time when the file was created, in ISO 8601 format
...
// FileForkName returns an attribute KeyValue conforming to the "file.fork_name"semantic conventions
// It represents the Name of the fork. A fork is additional data associated with a filesystem object
func FileForkName(val string) attribute.KeyValue {
	return FileForkNameKey.String(val)
}


// FileGroupId returns an attribute KeyValue conforming to the "file.group.id"semantic conventions
// It represents the Primary Group ID (GID) of the file
func FileGroupId(val string) attribute.KeyValue {
	return FileGroupIdKey.String(val)
}


// FileGroupName returns an attribute KeyValue conforming to the "file.group.name"semantic conventions
// It represents the Primary group name of the file
func FileGroupName(val string) attribute.KeyValue {
	return FileGroupNameKey.String(val)
}


// FileInode returns an attribute KeyValue conforming to the "file.inode"semantic conventions
// It represents the Inode representing the file in the filesystem
func FileInode(val string) attribute.KeyValue {
	return FileInodeKey.String(val)
}


// FileMode returns an attribute KeyValue conforming to the "file.mode"semantic conventions
// It represents the Mode of the file in octal representation
func FileMode(val string) attribute.KeyValue {
	return FileModeKey.String(val)
}


// FileModified returns an attribute KeyValue conforming to the "file.modified"semantic conventions
// It represents the Time when the file content was last modified, in ISO 8601 format
...
// FileOwnerId returns an attribute KeyValue conforming to the "file.owner.id"semantic conventions
// It represents the The user ID (UID) or security identifier (SID) of the file owner
func FileOwnerId(val string) attribute.KeyValue {
	return FileOwnerIdKey.String(val)
}


// FileOwnerName returns an attribute KeyValue conforming to the "file.owner.name"semantic conventions
// It represents the Username of the file owner
...
// FileSymbolicLinkTargetPath returns an attribute KeyValue conforming to the "file.symbolic_link.target_path"semantic conventions
// It represents the Path to the target of a symbolic link
...
// It represents the Deprecated, use Event API to report completions contents
func GenAiCompletion(val string) attribute.KeyValue {
	return GenAiCompletionKey.String(val)
}


// GenAiOpenaiRequestResponseFormat returns an attribute KeyValue conforming to the "gen_ai.openai.request.response_format"semantic conventions
// It represents the The response format that is requested
func GenAiOpenaiRequestResponseFormat(val string) attribute.KeyValue {
	return GenAiOpenaiRequestResponseFormatKey.String(val)
}


// GenAiOpenaiRequestSeed returns an attribute KeyValue conforming to the "gen_ai.openai.request.seed"semantic conventions
// It represents the Requests with same seed value more likely to return same result
func GenAiOpenaiRequestSeed(val int) attribute.KeyValue {
	return GenAiOpenaiRequestSeedKey.Int(val)
}


// GenAiOpenaiRequestServiceTier returns an attribute KeyValue conforming to the "gen_ai.openai.request.service_tier"semantic conventions
// It represents the The service tier requested. May be a specific tier, detault, or auto
func GenAiOpenaiRequestServiceTier(val string) attribute.KeyValue {
	return GenAiOpenaiRequestServiceTierKey.String(val)
}


// GenAiOpenaiResponseServiceTier returns an attribute KeyValue conforming to the "gen_ai.openai.response.service_tier"semantic conventions
// It represents the The service tier used for the response
...
// It represents the Deprecated, use Event API to report prompt contents
...
// It represents the Deprecated, use `http.request.header.<key>` instead
...
// It represents the Deprecated, use `http.response.header.<key>` instead
...
// It represents the Deprecated, use `messaging.destination.subscription.name` instead
...
var (
	...
	// Stability: experimental	// Replaced by `send`
...
// ProcessExecutableBuildIdGnu returns an attribute KeyValue conforming to the "process.executable.build_id.gnu"semantic conventions
// It represents the The GNU build ID as found in the `.note.gnu.build-id` ELF section (hex string)
func ProcessExecutableBuildIdGnu(val string) attribute.KeyValue {
	return ProcessExecutableBuildIdGnuKey.String(val)
}


// ProcessExecutableBuildIdGo returns an attribute KeyValue conforming to the "process.executable.build_id.go"semantic conventions
// It represents the The Go build ID as retrieved by `go tool buildid <go executable>`
func ProcessExecutableBuildIdGo(val string) attribute.KeyValue {
	return ProcessExecutableBuildIdGoKey.String(val)
}


// ProcessExecutableBuildIdProfiling returns an attribute KeyValue conforming to the "process.executable.build_id.profiling"semantic conventions
// It represents the Profiling specific build ID for executables. See the OTel specification for Profiles for more information
