...
const (
	...
	//
	// Type: string
	// RequirementLevel: {"Conditionally_Required": "If And Only If The Exception
...
const (
	...
	// "/subscriptions/<SUBSCIPTION_GUID>/resourceGroups/<RG>
...
const (
	...
	// run by the container as a single string representing the full command. [2].
	//
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Development
...
const (
	...
	// "db.cosmosdb.operation_type" semantic conventions. It represents the cosmosDB
	// Operation Type.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	...
	//
	// [batch operation]: /docs/database/database-spans.md#batch-operations
...
// Namespace: gen_ai
const (
	// GenAICompletionKey is the attribute Key conforming to the "gen_ai.completion"
	// semantic conventions. It represents the full response received from the GenAI
	// model.
	//
	// Type: string
	// RequirementLevel: Recommended
	...
	// semantic conventions. It represents the full prompt sent to the GenAI model.
	//
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Development
	...
	// Note: It's RECOMMENDED to format prompts as JSON string matching
	// [OpenAI messages format]
	//
	// [OpenAI messages format]: https://platform.openai.com/docs/guides/text-generation
...
// GenAIPrompt returns an attribute KeyValue conforming to the "gen_ai.prompt"
// semantic conventions. It represents the full prompt sent to the GenAI model.
...
// "log.record.original" semantic conventions. It represents the complete orignal
// Log Record.
...
var (
	// One or more messages are provided for publishing to an intermediary. If a
	// single message is published, the context of the "Publish" span can be used as
	...
	// used to provide a unique creation context for messages in batch publishing
	// scenarios.
	//
	// Stability: development
