...
// Namespace: cpython
const (
	// CpythonGCGenerationKey is the attribute Key conforming to the
	// "cpython.gc.generation" semantic conventions. It represents the value of the
	// garbage collector collection generation.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Development
	//
	// Examples: 0, 1, 2
	CpythonGCGenerationKey = attribute.Key("cpython.gc.generation")
)

// Enum values for cpython.gc.generation
var (
	// Generation 0
	// Stability: development
	CpythonGCGenerationGeneration0 = CpythonGCGenerationKey.Int(0)
	// Generation 1
	// Stability: development
	CpythonGCGenerationGeneration1 = CpythonGCGenerationKey.Int(1)
	// Generation 2
	// Stability: development
	CpythonGCGenerationGeneration2 = CpythonGCGenerationKey.Int(2)
)
