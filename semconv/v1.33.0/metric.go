...
package semconv // import "go.opentelemetry.io/otel/semconv/v1.33.0"
...
const (
  ...
  // CpythonGCCollectedObjects is the metric conforming to the
  // "cpython.gc.collected_objects" semantic conventions. It represents the total
  // number of objects collected inside a generation since interpreter start.
  // Instrument: counter
  // Unit: {object}
  // Stability: development
  CpythonGCCollectedObjectsName = "cpython.gc.collected_objects"
  CpythonGCCollectedObjectsUnit = "{object}"
  CpythonGCCollectedObjectsDescription = "The total number of objects collected inside a generation since interpreter start."
  // CpythonGCCollections is the metric conforming to the
  ...
  // Unit: {collection}
  // Stability: development
  CpythonGCCollectionsName = "cpython.gc.collections"
  CpythonGCCollectionsUnit = "{collection}"
  CpythonGCCollectionsDescription = "The number of times a generation was collected since interpreter start."
  // CpythonGCUncollectableObjects is the metric conforming to the
  // "cpython.gc.uncollectable_objects" semantic conventions. It represents the
  // total number of objects which were found to be uncollectable inside a
  // generation since interpreter start.
  // Instrument: counter
  // Unit: {object}
  // Stability: development
  CpythonGCUncollectableObjectsName = "cpython.gc.uncollectable_objects"
  CpythonGCUncollectableObjectsUnit = "{object}"
  CpythonGCUncollectableObjectsDescription = "The total number of objects which were found to be uncollectable inside a generation since interpreter start."
  ...
  // OTelSDKExporterLogExported is the metric conforming to the
  // "otel.sdk.exporter.log.exported" semantic conventions. It represents the
  // number of log records for which the export has finished, either successful
  // or failed.
  // Instrument: counter
  // Unit: {log_record}
  // Stability: development
  OTelSDKExporterLogExportedName = "otel.sdk.exporter.log.exported"
  OTelSDKExporterLogExportedUnit = "{log_record}"
  OTelSDKExporterLogExportedDescription = "The number of log records for which the export has finished, either successful or failed"
  // OTelSDKExporterLogInflight is the metric conforming to the
  // "otel.sdk.exporter.log.inflight" semantic conventions. It represents the
  // number of log records which were passed to the exporter, but that have not
  // been exported yet (neither successful, nor failed).
  // Instrument: updowncounter
  // Unit: {log_record}
  // Stability: development
  OTelSDKExporterLogInflightName = "otel.sdk.exporter.log.inflight"
  OTelSDKExporterLogInflightUnit = "{log_record}"
  OTelSDKExporterLogInflightDescription = "The number of log records which were passed to the exporter, but that have not been exported yet (neither successful, nor failed)"
  // OTelSDKExporterMetricDataPointExported is the metric conforming to the
  // "otel.sdk.exporter.metric_data_point.exported" semantic conventions. It
  // represents the number of metric data points for which the export has
  // finished, either successful or failed.
  // Instrument: counter
  // Unit: {data_point}
  // Stability: development
  OTelSDKExporterMetricDataPointExportedName = "otel.sdk.exporter.metric_data_point.exported"
  OTelSDKExporterMetricDataPointExportedUnit = "{data_point}"
  OTelSDKExporterMetricDataPointExportedDescription = "The number of metric data points for which the export has finished, either successful or failed"
  // OTelSDKExporterMetricDataPointInflight is the metric conforming to the
  // "otel.sdk.exporter.metric_data_point.inflight" semantic conventions. It
  // represents the number of metric data points which were passed to the
  // exporter, but that have not been exported yet (neither successful, nor
  // failed).
  // Instrument: updowncounter
  // Unit: {data_point}
  // Stability: development
  OTelSDKExporterMetricDataPointInflightName = "otel.sdk.exporter.metric_data_point.inflight"
  OTelSDKExporterMetricDataPointInflightUnit = "{data_point}"
  OTelSDKExporterMetricDataPointInflightDescription = "The number of metric data points which were passed to the exporter, but that have not been exported yet (neither successful, nor failed)"
  // OTelSDKExporterOperationDuration is the metric conforming to the
  // "otel.sdk.exporter.operation.duration" semantic conventions. It represents
  // the duration of exporting a batch of telemetry records.
  // Instrument: histogram
  // Unit: s
  // Stability: development
  OTelSDKExporterOperationDurationName = "otel.sdk.exporter.operation.duration"
  OTelSDKExporterOperationDurationUnit = "s"
  OTelSDKExporterOperationDurationDescription = "The duration of exporting a batch of telemetry records."
  // OTelSDKExporterSpanExported is the metric conforming to the
  // "otel.sdk.exporter.span.exported" semantic conventions. It represents the
  // number of spans for which the export has finished, either successful or
  // failed.
  // Instrument: counter
  // Unit: {span}
  // Stability: development
  OTelSDKExporterSpanExportedName = "otel.sdk.exporter.span.exported"
  OTelSDKExporterSpanExportedUnit = "{span}"
  OTelSDKExporterSpanExportedDescription = "The number of spans for which the export has finished, either successful or failed"
  // OTelSDKExporterSpanInflight is the metric conforming to the
  // "otel.sdk.exporter.span.inflight" semantic conventions. It represents the
  // number of spans which were passed to the exporter, but that have not been
  // exported yet (neither successful, nor failed).
  // Instrument: updowncounter
  // Unit: {span}
  // Stability: development
  OTelSDKExporterSpanInflightName = "otel.sdk.exporter.span.inflight"
  OTelSDKExporterSpanInflightUnit = "{span}"
  OTelSDKExporterSpanInflightDescription = "The number of spans which were passed to the exporter, but that have not been exported yet (neither successful, nor failed)"
  // OTelSDKLogCreated is the metric conforming to the "otel.sdk.log.created"
  // semantic conventions. It represents the number of logs submitted to enabled
  // SDK Loggers.
  // Instrument: counter
  // Unit: {log_record}
  // Stability: development
  OTelSDKLogCreatedName = "otel.sdk.log.created"
  OTelSDKLogCreatedUnit = "{log_record}"
  OTelSDKLogCreatedDescription = "The number of logs submitted to enabled SDK Loggers"
  // OTelSDKMetricReaderCollectionDuration is the metric conforming to the
  // "otel.sdk.metric_reader.collection.duration" semantic conventions. It
  // represents the duration of the collect operation of the metric reader.
  // Instrument: histogram
  // Unit: s
  // Stability: development
  OTelSDKMetricReaderCollectionDurationName = "otel.sdk.metric_reader.collection.duration"
  OTelSDKMetricReaderCollectionDurationUnit = "s"
  OTelSDKMetricReaderCollectionDurationDescription = "The duration of the collect operation of the metric reader."
  // OTelSDKProcessorLogProcessed is the metric conforming to the
  // "otel.sdk.processor.log.processed" semantic conventions. It represents the
  // number of log records for which the processing has finished, either
  // successful or failed.
  // Instrument: counter
  // Unit: {log_record}
  // Stability: development
  OTelSDKProcessorLogProcessedName = "otel.sdk.processor.log.processed"
  OTelSDKProcessorLogProcessedUnit = "{log_record}"
  OTelSDKProcessorLogProcessedDescription = "The number of log records for which the processing has finished, either successful or failed"
  // OTelSDKProcessorLogQueueCapacity is the metric conforming to the
  // "otel.sdk.processor.log.queue.capacity" semantic conventions. It represents
  // the maximum number of log records the queue of a given instance of an SDK
  // Log Record processor can hold.
  // Instrument: updowncounter
  // Unit: {log_record}
  // Stability: development
  OTelSDKProcessorLogQueueCapacityName = "otel.sdk.processor.log.queue.capacity"
  OTelSDKProcessorLogQueueCapacityUnit = "{log_record}"
  OTelSDKProcessorLogQueueCapacityDescription = "The maximum number of log records the queue of a given instance of an SDK Log Record processor can hold"
  // OTelSDKProcessorLogQueueSize is the metric conforming to the
  // "otel.sdk.processor.log.queue.size" semantic conventions. It represents the
  // number of log records in the queue of a given instance of an SDK log
  // processor.
  // Instrument: updowncounter
  // Unit: {log_record}
  // Stability: development
  OTelSDKProcessorLogQueueSizeName = "otel.sdk.processor.log.queue.size"
  OTelSDKProcessorLogQueueSizeUnit = "{log_record}"
  OTelSDKProcessorLogQueueSizeDescription = "The number of log records in the queue of a given instance of an SDK log processor"
  // OTelSDKProcessorSpanProcessed is the metric conforming to the
  // "otel.sdk.processor.span.processed" semantic conventions. It represents the
  // number of spans for which the processing has finished, either successful or
  // failed.
  // Instrument: counter
  // Unit: {span}
  // Stability: development
  OTelSDKProcessorSpanProcessedName = "otel.sdk.processor.span.processed"
  OTelSDKProcessorSpanProcessedUnit = "{span}"
  OTelSDKProcessorSpanProcessedDescription = "The number of spans for which the processing has finished, either successful or failed"
  ...
  // OTelSDKSpanEnded is the metric conforming to the "otel.sdk.span.ended"
  // semantic conventions. It represents the number of created spans for which
  // the end operation was called.
  // Instrument: counter
  // Unit: {span}
  // Stability: development
  OTelSDKSpanEndedName = "otel.sdk.span.ended"
  OTelSDKSpanEndedUnit = "{span}"
  OTelSDKSpanEndedDescription = "The number of created spans for which the end operation was called"
  // OTelSDKSpanLive is the metric conforming to the "otel.sdk.span.live"
  // semantic conventions. It represents the number of created spans for which
  // the end operation has not been called yet.
  // Instrument: updowncounter
  // Unit: {span}
  // Stability: development
  OTelSDKSpanLiveName = "otel.sdk.span.live"
  OTelSDKSpanLiveUnit = "{span}"
  OTelSDKSpanLiveDescription = "The number of created spans for which the end operation has not been called yet"
