...
const (
	// ASPNETCoreDiagnosticsExceptionResultKey is the attribute Key conforming to
	// the "aspnetcore.diagnostics.exception.result" semantic conventions. It
	// represents the aSP.NET Core exception middleware handling result.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// ASPNETCoreDiagnosticsHandlerTypeKey is the attribute Key conforming to the
	// "aspnetcore.diagnostics.handler.type" semantic conventions. It represents the
	...
	// "aspnetcore.rate_limiting.policy" semantic conventions. It represents the
	...
	// "aspnetcore.rate_limiting.result" semantic conventions. It represents the
	...
	// "aspnetcore.request.is_unhandled" semantic conventions. It represents the
	...
	// "aspnetcore.routing.is_fallback" semantic conventions. It represents a value
	// that indicates whether the matched route is a fallback route.
	//
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// "aspnetcore.routing.match_status" semantic conventions. It represents the
...
// ASPNETCoreDiagnosticsHandlerType returns an attribute KeyValue conforming to
// the "aspnetcore.diagnostics.handler.type" semantic conventions. It represents
// the full type name of the [`IExceptionHandler`] implementation that handled
// the exception.
//
// [`IExceptionHandler`]: https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.diagnostics.iexceptionhandler
...
// ASPNETCoreRateLimitingPolicy returns an attribute KeyValue conforming to the
// "aspnetcore.rate_limiting.policy" semantic conventions. It represents the rate
// limiting policy name.
func ASPNETCoreRateLimitingPolicy(val string) attribute.KeyValue {
	return ASPNETCoreRateLimitingPolicyKey.String(val)
}

// ASPNETCoreRequestIsUnhandled returns an attribute KeyValue conforming to the
// "aspnetcore.request.is_unhandled" semantic conventions. It represents the flag
// indicating if request was handled by the application pipeline.
func ASPNETCoreRequestIsUnhandled(val bool) attribute.KeyValue {
	return ASPNETCoreRequestIsUnhandledKey.Bool(val)
}

// ASPNETCoreRoutingIsFallback returns an attribute KeyValue conforming to the
// "aspnetcore.routing.is_fallback" semantic conventions. It represents a value
// that indicates whether the matched route is a fallback route.
...
const (
	...
	// DBCosmosDBConsistencyLevelKey is the attribute Key conforming to the
	...
	DBCosmosDBConsistencyLevelKey = attribute.Key("db.cosmosdb.consistency_level")

	// DBCosmosDBRegionsContactedKey is the attribute Key conforming to the
	// "db.cosmosdb.regions_contacted" semantic conventions. It represents the list
	// of regions contacted during operation in the order that they were contacted.
	// If there is more than one region listed, it indicates that the operation was
	// performed on multiple regions i.e. cross-regional call.
	//
	// Type: string[]
	// RequirementLevel: Recommended
	// Stability: Development
	...
	DBCosmosDBRegionsContactedKey = attribute.Key("db.cosmosdb.regions_contacted")

	// DBCosmosDBRequestChargeKey is the attribute Key conforming to the
	// "db.cosmosdb.request_charge" semantic conventions. It represents the request
	// units consumed for the operation.
	//
	// Type: double
	// RequirementLevel: Recommended
	// Stability: Development
...
// DBCosmosDBRegionsContacted returns an attribute KeyValue conforming to the
// "db.cosmosdb.regions_contacted" semantic conventions. It represents the list
// of regions contacted during operation in the order that they were contacted.
// If there is more than one region listed, it indicates that the operation was
// performed on multiple regions i.e. cross-regional call.
func DBCosmosDBRegionsContacted(val ...string) attribute.KeyValue {
	return DBCosmosDBRegionsContactedKey.StringSlice(val)
}
...
// Enum values for db.cosmosdb.consistency_level
var (
	// strong
	// Stability: development
	DBCosmosDBConsistencyLevelStrong = DBCosmosDBConsistencyLevelKey.String("Strong")
	// bounded_staleness
	// Stability: development
	DBCosmosDBConsistencyLevelBoundedStaleness = DBCosmosDBConsistencyLevelKey.String("BoundedStaleness")
	// session
	// Stability: development
	DBCosmosDBConsistencyLevelSession = DBCosmosDBConsistencyLevelKey.String("Session")
	// eventual
	// Stability: development
	DBCosmosDBConsistencyLevelEventual = DBCosmosDBConsistencyLevelKey.String("Eventual")
	// consistent_prefix
	// Stability: development
	DBCosmosDBConsistencyLevelConsistentPrefix = DBCosmosDBConsistencyLevelKey.String("ConsistentPrefix")
)
...
// Namespace: dotnet
const (
	// DotnetGCHeapGenerationKey is the attribute Key conforming to the
	// "dotnet.gc.heap.generation" semantic conventions. It represents the name of
	// the garbage collector managed heap generation.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
...
const (
	...
	// semantic conventions. It represents the name of the garbage collector action.
	//
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMGCNameKey is the attribute Key conforming to the "jvm.gc.name" semantic
	// conventions. It represents the name of the garbage collector.
	//
	// Type: string
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMMemoryTypeKey is the attribute Key conforming to the "jvm.memory.type"
	// semantic conventions. It represents the type of memory.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	...
	// JVMThreadDaemonKey is the attribute Key conforming to the "jvm.thread.daemon"
	// semantic conventions. It represents the whether the thread is daemon or not.
	//
	// Type: boolean
	// RequirementLevel: Recommended
	// Stability: Stable
	...
	// JVMThreadStateKey is the attribute Key conforming to the "jvm.thread.state"
	// semantic conventions. It represents the state of the thread.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Stable
...
// JVMGCAction returns an attribute KeyValue conforming to the "jvm.gc.action"
// semantic conventions. It represents the name of the garbage collector action.
...
// "jvm.thread.daemon" semantic conventions. It represents the whether the thread
// is daemon or not.
...
// Namespace: nodejs
const (
	// NodejsEventloopStateKey is the attribute Key conforming to the
	// "nodejs.eventloop.state" semantic conventions. It represents the state of
	// event loop time.
	//
	// Type: Enum
	// RequirementLevel: Recommended
...
// Namespace: v8js
const (
	// V8JSGCTypeKey is the attribute Key conforming to the "v8js.gc.type" semantic
	// conventions. It represents the type of garbage collection.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Development
	...
	// "v8js.heap.space.name" semantic conventions. It represents the name of the
	// space type of heap memory.
	//
	// Type: Enum
	// RequirementLevel: Recommended
	// Stability: Development
