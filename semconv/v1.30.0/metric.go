...
const (
  ...
  DBClientCosmosDBActiveInstanceCountDescription = "Number of active client instances"
  ...
  // represents the [Request charge] consumed by the operation.
  //
  // [Request charge]: https://learn.microsoft.com/azure/cosmos-db/request-units
  // Instrument: histogram
  // Unit: {request_unit}
  // Stability: development
  ...
  DBClientCosmosDBOperationRequestChargeDescription = "[Request charge](https://learn.microsoft.com/azure/cosmos-db/request-units) consumed by the operation"
  ...
  // DotnetAssemblyCount is the metric conforming to the "dotnet.assembly.count"
  // semantic conventions. It represents the number of .NET assemblies that are
  // currently loaded.
  // Instrument: updowncounter
  // Unit: {assembly}
  // Stability: stable
  ...
  // DotnetExceptions is the metric conforming to the "dotnet.exceptions"
  // semantic conventions. It represents the number of exceptions that have been
  // thrown in managed code.
  // Instrument: counter
  // Unit: {exception}
  // Stability: stable
  ...
  // DotnetGCCollections is the metric conforming to the "dotnet.gc.collections"
  // semantic conventions. It represents the number of garbage collections that
  // have occurred since the process has started.
  // Instrument: counter
  // Unit: {collection}
  // Stability: stable
  ...
  // DotnetGCHeapTotalAllocated is the metric conforming to the
  // "dotnet.gc.heap.total_allocated" semantic conventions. It represents the
  // *approximate* number of bytes allocated on the managed GC heap since the
  // process has started. The returned value does not include any native
  // allocations.
  // Instrument: counter
  // Unit: By
  // Stability: stable
  ...
  // DotnetGCLastCollectionHeapFragmentationSize is the metric conforming to the
  // "dotnet.gc.last_collection.heap.fragmentation.size" semantic conventions. It
  // represents the heap fragmentation, as observed during the latest garbage
  // collection.
  // Instrument: updowncounter
  // Unit: By
  // Stability: stable
  ...
  // DotnetGCLastCollectionHeapSize is the metric conforming to the
  // "dotnet.gc.last_collection.heap.size" semantic conventions. It represents
  ...
  // DotnetGCLastCollectionMemoryCommittedSize is the metric conforming to the
  // "dotnet.gc.last_collection.memory.committed_size" semantic conventions. It
  // represents the amount of committed virtual memory in use by the .NET GC, as
  ...
  // DotnetGCPauseTime is the metric conforming to the "dotnet.gc.pause.time"
  // semantic conventions. It represents the total amount of time paused in GC
  // since the process has started.
  // Instrument: counter
  // Unit: s
  // Stability: stable
  ...
  // DotnetJitCompilationTime is the metric conforming to the
  // "dotnet.jit.compilation.time" semantic conventions. It represents the amount
  // of time the JIT compiler has spent compiling methods since the process has
  // started.
  // Instrument: counter
  // Unit: s
  // Stability: stable
  ...
  // DotnetJitCompiledIlSize is the metric conforming to the
  // "dotnet.jit.compiled_il.size" semantic conventions. It represents the count
  // of bytes of intermediate language that have been compiled since the process
  // has started.
  // Instrument: counter
  // Unit: By
  // Stability: stable
  ...
  // DotnetJitCompiledMethods is the metric conforming to the
  // "dotnet.jit.compiled_methods" semantic conventions. It represents the number
  // of times the JIT compiler (re)compiled methods since the process has
  // started.
  // Instrument: counter
  // Unit: {method}
  // Stability: stable
  ...
  // DotnetMonitorLockContentions is the metric conforming to the
  // "dotnet.monitor.lock_contentions" semantic conventions. It represents the
  // number of times there was contention when trying to acquire a monitor lock
  // since the process has started.
  // Instrument: counter
  // Unit: {contention}
  // Stability: stable
  ...
  // DotnetProcessCPUCount is the metric conforming to the
  // "dotnet.process.cpu.count" semantic conventions. It represents the number of
  ...
  // DotnetProcessCPUTime is the metric conforming to the
  // "dotnet.process.cpu.time" semantic conventions. It represents the cPU time
  // used by the process.
  // Instrument: counter
  // Unit: s
  // Stability: stable
  ...
  // DotnetProcessMemoryWorkingSet is the metric conforming to the
  // "dotnet.process.memory.working_set" semantic conventions. It represents the
  // number of bytes of physical memory mapped to the process context.
  // Instrument: updowncounter
  // Unit: By
  // Stability: stable
  ...
  // DotnetThreadPoolQueueLength is the metric conforming to the
  // "dotnet.thread_pool.queue.length" semantic conventions. It represents the
  // number of work items that are currently queued to be processed by the thread
  // pool.
  // Instrument: updowncounter
  // Unit: {work_item}
  // Stability: stable
  ...
  // DotnetThreadPoolThreadCount is the metric conforming to the
  // "dotnet.thread_pool.thread.count" semantic conventions. It represents the
  ...
  // DotnetThreadPoolWorkItemCount is the metric conforming to the
  // "dotnet.thread_pool.work_item.count" semantic conventions. It represents the
  // number of work items that the thread pool has completed since the process
  // has started.
  // Instrument: counter
  // Unit: {work_item}
  // Stability: stable
  ...
  // DotnetTimerCount is the metric conforming to the "dotnet.timer.count"
  // semantic conventions. It represents the number of timer instances that are
  // currently active.
  // Instrument: updowncounter
  // Unit: {timer}
  // Stability: stable
  ...
  // NodejsEventloopTime is the metric conforming to the "nodejs.eventloop.time"
  // semantic conventions. It represents the cumulative duration of time the
  // event loop has been in each state.
  // Instrument: counter
  // Unit: s
  // Stability: development
