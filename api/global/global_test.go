...
func TestMulitpleGlobalSetScope(t *testing.T) {
	...
	s1 := scope.WithTracerSDK(trace.NoopTracerSDK{}).WithMeterSDK(metric.NoopMeterSDK{})
	s2 := scope.WithTracerSDK(trace.NoopTracerSDK{}).WithMeterSDK(metric.NoopMeterSDK{})
