...
func delegateCheck(impl hasImpl, err error) (metric.InstrumentImpl, error) {
	if impl != nil {
		return impl.Impl(), err
	}
	if err == nil {
...
func newInstDelegate(m metric.Meter, name string, mkind metricKind, nkind core.NumberKind, opts interface{}) (metric.InstrumentImpl, error) {
	...
	case gaugeKind:
		if nkind == core.Int64NumberKind {
			return delegateCheck(m.NewInt64Gauge(name, opts.([]metric.GaugeOptionApplier)...))
		}
		return delegateCheck(m.NewFloat64Gauge(name, opts.([]metric.GaugeOptionApplier)...))
	case measureKind:
		if nkind == core.Int64NumberKind {
...
func (inst *instImpl) setDelegate(d metric.Meter) {
	...
	// TODO: An error generated by the SDK should present somehow
	*implPtr, _ = newInstDelegate(d, inst.name, inst.mkind, inst.nkind, inst.opts)
...
func (obs *obsImpl) setInt64Delegate(d metric.Meter) {
	...
	// TODO: An error generated by the SDK should present somehow
	*obsPtr, _ = d.RegisterInt64Observer(obs.name, cb, obs.opts...)
...
func (obs *obsImpl) setFloat64Delegate(d metric.Meter) {
	...
	// TODO: An error generated by the SDK should present somehow
	*obsPtr, _ = d.RegisterFloat64Observer(obs.name, cb, obs.opts...)
	atomic.StorePointer(&obs.delegate, unsafe.Pointer(obsPtr))
}
...
func (m *meter) NewInt64Gauge(name string, opts ...metric.GaugeOptionApplier) (metric.Int64Gauge, error) {
	return metric.WrapInt64GaugeInstrument(m.newInst(name, gaugeKind, core.Int64NumberKind, opts))
}

func (m *meter) NewFloat64Gauge(name string, opts ...metric.GaugeOptionApplier) (metric.Float64Gauge, error) {
