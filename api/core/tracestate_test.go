...
func checkFront(t *testing.T, tracestate *Tracestate, wantKey, testname string) {
	gotKey := tracestate.entries[0].Key.Variable.Name
	if gotKey != wantKey {
...
func checkBack(t *testing.T, tracestate *Tracestate, wantKey, testname string) {
	gotKey := tracestate.entries[len(tracestate.entries)-1].Key.Variable.Name
	if gotKey != wantKey {
...
func TestCreateWithNullParent(t *testing.T) {
	...
	entry := createKeyValue(key1, value1)
...
func TestCreateFromParentWithSingleKey(t *testing.T) {
	...
	entry1 := createKeyValue(key1, value1)
	entry2 := createKeyValue(key2, value2)
...
func TestCreateFromParentWithDoubleKeys(t *testing.T) {
	...
	entry1 := createKeyValue(key1, value1)
	entry2 := createKeyValue(key2, value2)
	entry3 := createKeyValue(key3, value3)
...
func TestImplicitImmutableTracestate(t *testing.T) {
	...
	entry := createKeyValue(key3, value3)
...
func TestKeyWithValidChar(t *testing.T) {
	...
	entry := createKeyValue(key, "world")
	tracestate, err := New(nil, entry)
...
func TestValueWithInvalidChar(t *testing.T) {
	...
	for _, value := range keys {
		entry := createKeyValue("hello", value)
		tracestate, err := New(nil, entry)
...
func TestNilValue(t *testing.T) {
	...
	tracestate, err := New(nil, createKeyValue("hello", ""))
...
func TestInvalidKeyLen(t *testing.T) {
	...
	key := string(arrayRune)
	tracestate, err := New(nil, createKeyValue(key, "world"))
...
func TestInvalidValueLen(t *testing.T) {
	...
	tracestate, err := New(nil, createKeyValue("hello", value))
...
func TestCreateFromParentWithOverLimitKVPairs(t *testing.T) {
	...
	tracestate, err := New(parent, createKeyValue(key, "world"))
	wantError(t, tracestate, err, testname,
...
func createKeyValue(key, value string) KeyValue {
	return KeyValue{Key{registry.Variable{Name: key}}, Value{Type: STRING, String: value}}
