...
func Int(k string, v int) otel.KeyValue {
	return New(k).Int(v)
}
...
// type is 32 or 64 bits wide.
func Uint(k string, v uint) otel.KeyValue {
	return New(k).Uint(v)
}
