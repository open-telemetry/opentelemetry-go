...
func Int(k string, v int) kv.KeyValue {
	return New(k).Int(v)
}
...
// type is 32 or 64 bits wide.
func Uint(k string, v uint) kv.KeyValue {
	return New(k).Uint(v)
}

// Infer creates a new key-value pair instance with a passed name and
// automatic type inference. This is slower, and not type-safe.
func Infer(k string, value interface{}) kv.KeyValue {
	if value == nil {
		return String(k, "<nil>")
	}
