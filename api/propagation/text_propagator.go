...
// and distributed context into/from a carrier using HTTPSupplier interface.
...
type TextFormat interface {
	...
	Extract(ctx context.Context, supplier HTTPSupplier) (core.SpanContext, correlation.Map)
...
// store value for a key to an associated carrier.
