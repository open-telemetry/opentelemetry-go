...
- A `Valid` method to the `"go.opentelemetry.io/otel/attribute".KeyValue` type. (TBD)
...
- `"go.opentelemetry.io/otel/sdk/resource".NewWithAttributes` will now drop any invalid attributes passed. (TBD)
- `"go.opentelemetry.io/otel/sdk/resource".StringDetector` will now error if the produced attribute is invalid. (TBD)
