...
- Add experimental self-observability metrics `exporter.log.inflight`, `exporter.log.exported`, and `exporter.operation.duration` in `go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc`. 
