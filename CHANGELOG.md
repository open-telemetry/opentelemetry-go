...
- Generate explicit histogram bucket boundaries from weaver configuration for semconv HTTP and RPC duration instruments in `go.opentelemetry.io/otel/semconv/v1.41.0`. (#8002)
