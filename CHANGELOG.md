...
- Add package `go.opentelemetry.io/otel/semconv/v1.33.0`. The package contains semantic conventions from the `v1.33.0` version of the OpenTelemetry Semantic Conventions.
