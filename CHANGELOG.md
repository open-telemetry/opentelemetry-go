...
- The `go.opentelemetry.io/otel/exporters/otlp` exporter no longer supports trace export.  Use `go.opentelemetry.io/otel/exporters/otlp/otlptrace` instead. (#1990)
