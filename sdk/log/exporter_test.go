...
func TestChunker(t *testing.T) {
	t.Run("ZeroSize", func(t *testing.T) {
		...
		const size = 100
		_ = c.Export(context.Background(), makeRecords(size))
	...
	t.Run("Chunk", func(t *testing.T) {
		...
		assert.NoError(t, c.Export(context.Background(), makeRecords(5)))
		assert.NoError(t, c.Export(context.Background(), makeRecords(25)))
...
func TestTimeoutExporter(t *testing.T) {
	...
	t.Run("Timeout", func(t *testing.T) {
		...
		go func() {
			out <- e.Export(context.Background(), makeRecords(1))
		}()
...
func TestBufferExporter(t *testing.T) {
	...
	t.Run("Shutdown", func(t *testing.T) {
		...
		t.Run("ContextCancelled", func(t *testing.T) {
			...
			require.True(t, e.EnqueueExport(makeRecords(1)))
	...
	t.Run("Export", func(t *testing.T) {
		...
		t.Run("Error", func(t *testing.T) {
			...
			e := newBufferExporter(exp, 1)
			ctx, records := context.Background(), makeRecords(1)
		...
		t.Run("Stopped", func(t *testing.T) {
			...
			ctx := context.Background()
			_ = e.Shutdown(ctx)
			assert.NoError(t, e.Export(ctx, makeRecords(1)))
	...
	t.Run("EnqueueExport", func(t *testing.T) {
		...
		t.Run("Stopped", func(t *testing.T) {
			...
			assert.True(t, e.EnqueueExport(makeRecords(1)))
		})
	})
}
