...
The log package provides [BatchProcessor] and [SimpleProcessor]
that are configured with an [Exporter] implementation and
exports the log records to given destination. See
[go.opentelemetry.io/otel/exporters] for exporters that can be used as
or with these Processors.

The data generated by a LoggerProvider needs to include information about its
origin. A LoggerProvider needs to be configured with a Resource, using the
