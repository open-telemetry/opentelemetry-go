...
These features are added to the OpenTelemetry Go Log SDK prior to stabilization in the specification so that users can start experimenting with them and provide feedback.
