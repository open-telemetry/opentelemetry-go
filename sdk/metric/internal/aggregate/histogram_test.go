...
func TestHistogramImmutableBounds(t *testing.T) {
	...
	h.measure(t.Context(), 5, &attributesProvider{set: alice}, nil)
...
func TestDeltaHistogramReset(t *testing.T) {
	...
	h.measure(t.Context(), 1, &attributesProvider{set: alice}, nil)
	...
	h.measure(t.Context(), 1, &attributesProvider{set: bob}, nil)
