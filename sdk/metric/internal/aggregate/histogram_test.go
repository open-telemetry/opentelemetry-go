...
func TestHistogramImmutableBounds(t *testing.T) {
	...
	h.measure(t.Context(), 5, attribute.NewLazyFilteredSet(alice, nil))
...
func TestDeltaHistogramReset(t *testing.T) {
	...
	h.measure(t.Context(), 1, attribute.NewLazyFilteredSet(alice, nil))
	...
	h.measure(t.Context(), 1, attribute.NewLazyFilteredSet(bob, nil))
