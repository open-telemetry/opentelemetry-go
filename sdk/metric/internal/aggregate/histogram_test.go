...
func TestHistogramImmutableBounds(t *testing.T) {
	...
	measureCumulativeHistogram(h, t.Context(), 5, alice)
...
func TestDeltaHistogramReset(t *testing.T) {
	...
	measureDeltaHistogram(h, t.Context(), 1, alice)
	...
	measureDeltaHistogram(h, t.Context(), 1, bob)
...
func TestHistogramMinMaxUnset(t *testing.T) {
	...
	h.hotColdValMap[0].LoadOrStoreAttr(newLazyFilteredSet(alice, nil), func(attribute.Set) *histogramPoint[int64] {
		return hPt
	})
