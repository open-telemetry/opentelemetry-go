...
type fltrMeasure[N int64 | float64] func(ctx context.Context, value N, lazySet lazyFilteredSet)

func (b Builder[N]) filter(f fltrMeasure[N]) Measure[N] {
	if b.Filter != nil {
		fltr := b.Filter // Copy to make it immutable after assignment.
		return func(ctx context.Context, n N, a attribute.Set) {
			f(ctx, n, newLazyFilteredSet(a, fltr))
		}
	}
	return func(ctx context.Context, n N, a attribute.Set) {
		f(ctx, n, newLazyFilteredSet(a, nil))
	}
}
