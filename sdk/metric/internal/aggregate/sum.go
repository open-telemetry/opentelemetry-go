...
func (s *sumValueMap[N]) measure(
	...
	if fltrAttrs != nil {
		// If the user called AddWithAttributes with []attribute.KeyValue,
		// instead of Add with an attribute.Set, we can delay computing the
		// complete set until we know we need to store it.
