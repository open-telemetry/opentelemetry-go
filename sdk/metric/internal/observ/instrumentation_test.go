...
func TestNewInstrumentationObservabilityErrors(t *testing.T) {
	...
	_, err := observ.NewInstrumentation(ID, ComponentType)
...
func TestNewInstrumentationObservabilityDisabled(t *testing.T) {
	...
	got, err := observ.NewInstrumentation(ID, ComponentType)
...
func setup(t *testing.T) (*observ.Instrumentation, func() metricdata.ScopeMetrics) {
	...
	inst, err := observ.NewInstrumentation(ID, ComponentType)
...
func TestComponentName(t *testing.T) {
	tests := []struct {
		...
		{id: 0, want: "periodic_metric_reader/0"},
		{id: 1, want: "periodic_metric_reader/1"},
		{id: 42, want: "periodic_metric_reader/42"},
		{id: -1, want: "periodic_metric_reader/-1"},
	}

	for _, tt := range tests {
		got := observ.ComponentName(tt.id)
