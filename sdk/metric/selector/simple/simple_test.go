...
var (
	testCounterDesc           = otel.NewDescriptor("counter", otel.CounterKind, otel.Int64NumberKind)
	testUpDownCounterDesc     = otel.NewDescriptor("updowncounter", otel.UpDownCounterKind, otel.Int64NumberKind)
	testSumObserverDesc       = otel.NewDescriptor("sumobserver", otel.SumObserverKind, otel.Int64NumberKind)
	testUpDownSumObserverDesc = otel.NewDescriptor("updownsumobserver", otel.UpDownSumObserverKind, otel.Int64NumberKind)
	testValueRecorderDesc     = otel.NewDescriptor("valuerecorder", otel.ValueRecorderKind, otel.Int64NumberKind)
	testValueObserverDesc     = otel.NewDescriptor("valueobserver", otel.ValueObserverKind, otel.Int64NumberKind)
)
