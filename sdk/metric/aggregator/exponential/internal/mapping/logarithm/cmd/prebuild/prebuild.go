...
// This command generates the table of constants in
// ../../constants.go.  Because the formula used for LowerBoundary()
// cannot calculate the last valid boundary correctly (due to library
// limitations), the `maxBoundary` is calculated and stored here along
// with other factors.
...
// prebuiltMappings was generated by ./cmd/prebuild.
