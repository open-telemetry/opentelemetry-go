...
func TestLastValueUpdate(t *testing.T) {
	aggregatortest.RunProfiles(t, func(t *testing.T, profile aggregatortest.Profile) {
		...
		record := aggregatortest.NewAggregatorTest(otel.ValueObserverKind, profile.NumberKind)
...
func TestLastValueMerge(t *testing.T) {
	aggregatortest.RunProfiles(t, func(t *testing.T, profile aggregatortest.Profile) {
		...
		descriptor := aggregatortest.NewAggregatorTest(otel.ValueObserverKind, profile.NumberKind)
...
func TestLastValueNotSet(t *testing.T) {
	descriptor := aggregatortest.NewAggregatorTest(otel.ValueObserverKind, otel.Int64NumberKind)
