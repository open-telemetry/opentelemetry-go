...
func init() {
	tid, _ = otel.IDFromHex("01020304050607080102040810203040")
...
func TestLinks(t *testing.T) {
	...
	sc1 := otel.SpanContext{TraceID: otel.ID([16]byte{1, 1}), SpanID: otel.SpanID{3}}
...
func TestExecutionTracerTaskEnd(t *testing.T) {
	...
	tID, _ := otel.IDFromHex("0102030405060708090a0b0c0d0e0f")
