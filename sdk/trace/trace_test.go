...
func TestWithResource(t *testing.T) {
	...
	tp := NewTracerProvider(WithSyncer(te),
		...
		WithResource(resource.NewFromAttributes(label.String("rk1", "rv1"), label.Int64("rk2", 5))))
	...
	want := &export.SpanData{
		...
		SpanKind:               otel.SpanKindInternal,
		HasRemoteParent:        true,
		Resource:               resource.NewFromAttributes(label.String("rk1", "rv1"), label.Int64("rk2", 5)),
