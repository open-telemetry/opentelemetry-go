...
// NewFromAttributes creates a resource from a set of attributes.  If there are
// duplicate keys present in the list of attributes, then the last
// value found for the key is preserved.
func NewFromAttributes(kvs ...label.KeyValue) *Resource {
	return &Resource{
...
func Merge(a, b *Resource) *Resource {
	...
	return NewFromAttributes(combine...)
}
