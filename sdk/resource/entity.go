...
package resource // import "go.opentelemetry.io/otel/sdk/trace"
...
// ReadOnlyEntity allows reading information from the data structure underlying a
...
type ReadWriteEntity interface {
	entity.Entity
	ReadOnlyEntity
}
...
type recordingSpan struct {
	...
	// ReadOnlyEntity exported when the span ends.
	attributes        []attribute.KeyValue
	droppedAttributes int
...
var (
	_ ReadWriteEntity = (*recordingSpan)(nil)
