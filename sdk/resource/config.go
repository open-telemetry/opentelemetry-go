...
// WithProcessCommandArgs, WithProcessCommandLine, WithProcessOwner,
// WithProcessRuntimeName, WithProcessRuntimeVersion,
// and WithProcessRuntimeDescription.
// See each option function for information about what resource
...
// WithProcessCommandLine adds an attribute with all the command arguments (including
// the command/executable itself) as received by the process to the configured
// Resource.
//
// Warning! This option will include process command line arguments. If these
// contain sensitive information it will be included in the exported resource.
func WithProcessCommandLine() Option {
	return WithDetectors(processCommandLineDetector{})
}
