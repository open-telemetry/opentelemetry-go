...
var (
	...
	measureTwo = metric.NewMeasure("ex.com/two")
)
...
func main() {
	...
	err := tracer.WithSpan(ctx, "operation", func(ctx context.Context) error {
		...
		meter.RecordBatch(
			...
			oneMetric.Float64Measurement(1.0),
			measureTwo.Float64Measurement(2.0),
		)
